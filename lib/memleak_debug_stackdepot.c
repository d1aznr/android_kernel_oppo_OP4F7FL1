...
static struct ml_stack_record *ml_depot_alloc_stack(unsigned long *entries,
						    int size, u32 hash,
						    void **prealloc,
						    gfp_t alloc_flags)
{
 ...
 */
static inline int ml_stackdepot_memcmp(const unsigned long *u1,
...
static inline struct ml_stack_record *
ml_find_stack(struct ml_stack_record *bucket, unsigned long *entries, int size,
	      u32 hash)
{
...
void ml_depot_fetch_stack(ml_depot_stack_handle_t handle,
