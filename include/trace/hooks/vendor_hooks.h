...
#define DECLARE_RESTRICTED_HOOK(name, proto, args, cond) DEFINE_TRACE(name)
...
#define __DECLARE_HOOK(name, proto, args, cond, data_proto, data_args)         \
	...
	{                                                                      \
		if (static_key_false(&__tracepoint_##name.key))                \
			DO_HOOK(&__tracepoint_##name, TP_PROTO(data_proto),    \
				TP_ARGS(data_args), TP_CONDITION(cond));       \
	}                                                                      \
...
#define DECLARE_RESTRICTED_HOOK(name, proto, args, cond)                       \
	__DECLARE_HOOK(name, PARAMS(proto), PARAMS(args), cond,                \
		       PARAMS(void *__data, proto), PARAMS(__data, args))
