...
static inline bool is_tpd_task(struct task_struct *tsk)
{
	return tsk ? (tsk->tpd > 0) : false;
}
static inline bool is_st_tpd_task(struct task_struct *tsk)
{
	return tsk ? (tsk->tpd_st != 0) : false;
}
...
#else
static inline bool is_tpd_enable(void)
{
	return false;
}
static inline int tpd_suggested(struct task_struct *tsk, int request_cluster)
{
	return request_cluster;
}
static inline int tpd_suggested_cpu(struct task_struct *tsk, int request_cpu)
{
	return request_cpu;
}
...
static inline bool tpd_check(struct task_struct *tsk, int dest_cpu)
{
	return false;
}
static inline bool is_dynamic_tpd_task(struct task_struct *tsk)
{
	return false;
}
static inline bool is_tpd_task(struct task_struct *tsk)
...
static inline bool is_st_tpd_enable(void)
{
	return false;
}
