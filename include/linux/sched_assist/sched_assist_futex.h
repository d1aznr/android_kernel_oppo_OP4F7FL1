...
extern void futex_set_inherit_ux(struct task_struct *owner,
				 struct task_struct *task);
extern void futex_unset_inherit_ux(struct task_struct *task);
extern void futex_set_inherit_ux_refs(struct task_struct *owner,
				      struct task_struct *task);
extern int futex_set_inherit_ux_refs_v2(struct task_struct *owner,
					struct task_struct *task);
