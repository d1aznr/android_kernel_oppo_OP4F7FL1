...
#define CMD_ID_SET_FPS _IOWR(OFB_MAGIC, SET_FPS, struct ofb_ctrl_data)
#define CMD_ID_BOOST_HIT _IOWR(OFB_MAGIC, BOOST_HIT, struct ofb_ctrl_data)
#define CMD_ID_END_FRAME _IOWR(OFB_MAGIC, END_FRAME, struct ofb_ctrl_data)
...
#define CMD_ID_IS_HWUI_RT _IOWR(OFB_MAGIC, IS_HWUI_RT, struct ofb_ctrl_data)
