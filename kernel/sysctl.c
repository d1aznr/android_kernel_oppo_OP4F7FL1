...
#if defined(CONFIG_OPLUS_FEATURE_HUNG_TASK_ENHANCE) &&                         \
	defined(CONFIG_OPLUS_FEATURE_DEATH_HEALER)
...
extern int ob_pid;
extern int sysctl_ob_control_handler(struct ctl_table *table, int write,
...
static int one_thousand = 1000;
	...
	defined(CONFIG_OPLUS_FEATURE_UXIO_FIRST)
