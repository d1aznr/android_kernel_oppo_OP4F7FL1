...
#define DECOMPRESS_FRONTEND_INIT(__i)                                          \
	{                                                                      \
		.inode = __i, .clt = COLLECTOR_INIT(), .backmost = true,       \
	}
				     ...
				     struct list_head *pagepool)
{
	...
	gfp_t gfp =
		mapping_gfp_constraint(mc, GFP_KERNEL) & ~__GFP_DIRECT_RECLAIM;
			       ...
			       enum z_erofs_page_type type)
{
	...
	ret = z_erofs_pagevec_enqueue(&clt->vector, page, type, &occupied);
...
static void *jobqueueset_init(struct super_block *sb,
			      ...
			      struct z_erofs_unzip_io *fgq, bool forcefg)
{
	/*
...
static bool z_erofs_vle_submit_all(struct super_block *sb,
				   z_erofs_next_pcluster_t owned_head,
				   struct list_head *pagepool,
				   struct z_erofs_unzip_io *fgq, bool force_fg)
{
				     ...
				     struct list_head *pagepool, bool force_fg)
{
	...
	if (!z_erofs_vle_submit_all(sb, clt->owned_head, pagepool, io,
				    force_fg))
		return;
