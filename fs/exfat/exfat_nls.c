...
static u16 bad_dos_chars[] = {
	/* + , ; = [ ] */
	0x002B, 0x002C, 0x003B, 0x003D, 0x005B, 0x005D, 0xFF0B,
	0xFF0C, 0xFF1B, 0xFF1D, 0xFF3B, 0xFF3D, 0
};

static u16 bad_uni_chars[] = {
	/* " * / : < > ? \ | */
	0x0022, 0x002A, 0x002F, 0x003A, 0x003C,
	0x003E, 0x003F, 0x005C, 0x007C, 0
};
...
static s32 convert_uni_to_ch(struct nls_table *nls, u8 *ch, u16 uni,
			     s32 *lossy);
static s32 convert_ch_to_uni(struct nls_table *nls, u16 *uni, u8 *ch,
			     s32 *lossy);
...
u16 nls_upper(struct super_block *sb, u16 a)
{
	...
	if (EXFAT_SB(sb)->options.casesensitive)
		return a;
	if (p_fs->vol_utbl != NULL &&
	    (p_fs->vol_utbl)[get_col_index(a)] != NULL)
...
void nls_uniname_to_dosname(struct super_block *sb, DOS_NAME_T *p_dosname,
			    UNI_NAME_T *p_uniname, s32 *p_lossy)
{
			    ...
			    u8 *p_cstring, s32 *p_lossy)
{
	...
	*(++end_of_name) = '\0';
	...
	p_uniname->name_hash =
		calc_checksum_2byte((void *)upname, j << 1, 0, CS_DEFAULT);
