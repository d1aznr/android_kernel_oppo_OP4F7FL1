...
#define GET16(p_src) (((u16)(p_src)[0]) | (((u16)(p_src)[1]) << 8))
#define GET32(p_src)                                                           \
...
typedef struct {
	s32 (*alloc_cluster)(struct super_block *sb, s32 num_alloc,
			     CHAIN_T *p_chain);
	void (*free_cluster)(struct super_block *sb, CHAIN_T *p_chain,
			     s32 do_relse);
	s32 (*count_used_clusters)(struct super_block *sb);

	s32 (*init_dir_entry)(struct super_block *sb, CHAIN_T *p_dir, s32 entry,
			      u32 type, u32 start_clu, u64 size);
	s32 (*init_ext_entry)(struct super_block *sb, CHAIN_T *p_dir, s32 entry,
			      s32 num_entries, UNI_NAME_T *p_uniname,
			      DOS_NAME_T *p_dosname);
	s32 (*find_dir_entry)(struct super_block *sb, CHAIN_T *p_dir,
	...
	void (*delete_dir_entry)(struct super_block *sb, CHAIN_T *p_dir,
				 s32 entry, s32 offset, s32 num_entries);
	void (*get_uni_name_from_ext_entry)(struct super_block *sb,
					    CHAIN_T *p_dir, s32 entry,
					    u16 *uniname);
	s32 (*count_ext_entries)(struct super_block *sb, CHAIN_T *p_dir,
				 s32 entry, DENTRY_T *p_entry);
...
s32 exfat_init_dir_entry(struct super_block *sb, CHAIN_T *p_dir, s32 entry,
			 u32 type, u32 start_clu, u64 size);
s32 fat_init_ext_dir_entry(struct super_block *sb, CHAIN_T *p_dir, s32 entry,
			   s32 num_entries, UNI_NAME_T *p_uniname,
			   DOS_NAME_T *p_dosname);
s32 exfat_init_ext_dir_entry(struct super_block *sb, CHAIN_T *p_dir, s32 entry,
			     s32 num_entries, UNI_NAME_T *p_uniname,
			     DOS_NAME_T *p_dosname);
...
s32 extract_uni_name_from_name_entry(NAME_DENTRY_T *ep, u16 *uniname,
				     s32 order);
...
s32 rename_file(struct inode *inode, CHAIN_T *p_dir, s32 old_entry,
