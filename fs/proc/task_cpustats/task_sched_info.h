...
extern void update_task_sched_info(struct task_struct *p, u64 delay, int type,
				   int cpu);
...
extern void update_wake_tid(struct task_struct *p, struct task_struct *cur,
			    unsigned int type);
extern void update_running_start_time(struct task_struct *prev,
