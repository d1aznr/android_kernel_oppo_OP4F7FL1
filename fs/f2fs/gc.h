...
#define DEF_GC_THREAD_DIRTY_RATE_THRESHOLD                                     \
	20 /* select 20% oldest dirty section */
#define DEF_GC_THREAD_DIRTY_COUNT_THRESHOLD                                    \
	10 /* select at least 10 dirty section */
