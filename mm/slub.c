 ...
 */
#if defined(OPLUS_FEATURE_MEMLEAK_DETECT) && defined(CONFIG_KMALLOC_DEBUG) &&  \
	!defined(CONFIG_MEMLEAK_DETECT_THREAD)
...
static void init_tracking(struct kmem_cache *s, void *object)
{
	...
	!defined(CONFIG_KMALLOC_DEBUG) || defined(CONFIG_SLUB_DEBUG_ON) ||     \
	defined(CONFIG_OPLUS_FEATURE_SLABTRACE_DEBUG)
