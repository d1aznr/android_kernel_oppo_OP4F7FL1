...
extern void SetGyroOffset(UINT_16 GyroOffsetX, UINT_16 GyroOffsetY,
			  UINT_16 GyroOffsetZ);
extern void SetAcclOffset(UINT_16 AcclOffsetX, UINT_16 AcclOffsetY,
			  UINT_16 AcclOffsetZ);
extern void GetGyroOffset(UINT_16 *GyroOffsetX, UINT_16 *GyroOffsetY,
			  UINT_16 *GyroOffsetZ);
extern void GetAcclOffset(UINT_16 *AcclOffsetX, UINT_16 *AcclOffsetY,
			  UINT_16 *AcclOffsetZ);
