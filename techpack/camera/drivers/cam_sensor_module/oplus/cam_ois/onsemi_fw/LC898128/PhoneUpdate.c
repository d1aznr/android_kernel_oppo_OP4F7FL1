...
const DOWNLOAD_TBL_EXT DTbl[] = {
	{ 0x010102, CcUpdataCode128_01_01_01_02, UpDataCodeSize_01_01_01_02,
	  UpDataCodeCheckSum_01_01_01_02, CcFromCode128_01_01_01_02,
	  sizeof(CcFromCode128_01_01_01_02), FromCheckSum_01_01_01_02,
	  FromCheckSumSize_01_01_01_02 },
...
//********************************************************************************
UINT_8 FlashDownload128(UINT_8 ModuleVendor, UINT_8 ActVer, UINT_8 MasterSlave,
			UINT_8 FWType)
{
...
UINT_32 MeasGyAcOffset(void)
{
	...
	if (UlRsltSts == EXE_END) {
		...
		RamWrite32A(ACCLRAM_Z_AC_OFFSET,
			    SlMeasureAveValueB[1] - (INT_32)GSENS);
...
UINT_8 LoadUserAreaToPM(void)
{
	...
	do {
		if (ptr->Index == (((UINT_32)ModuleVendor << 16) +
				   ((UINT_32)ActVer << 8) + MasterSlave)) {
			if ((ptr->SizeFromCode % 64) != 0)
				return (0xF1);
