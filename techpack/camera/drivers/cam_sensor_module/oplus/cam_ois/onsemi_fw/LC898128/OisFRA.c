...
void SetThroughParameter(UINT_8 UcDirSel)
{
	...
	if (UcDirSel == X_DIR) {
		...
		RamWrite32A(HallFilterCoeffX_hxdgain0,
			    0x00000000); //RAMW32	80EC	00000000
		RamWrite32A(HallFilterCoeffX_hxpgain0,
			    0x7fffffff); //RAMW32	80D8	7fffffff
		RamWrite32A(HallFilterCoeffX_hxpgain1,
			    0x7fffffff); //RAMW32	80E4	7fffffff
		RamWrite32A(HallFilterCoeffX_hxigain0,
			    0x00000000); //RAMW32	80E8	00000000
		RamWrite32A(HallFilterCoeffX_hxgain0,
			    0x7fffffff); //RAMW32	80F0	7fffffff
		if (Info.Model == 0x01) { // KW
			RamWrite32A(
				HallFilterShiftX,
				0x00000001); //RAMW32	81F8	00000000  +6dB
		} else {
			RamWrite32A(
				HallFilterShiftX,
				0x00000000); //RAMW32	81F8	00000000
		}
		RamWrite32A((HallFilterShiftX + 4),
			    0x00000000); //RAMW32	81FC	00000000
		RamWrite32A(HallFilterCoeffX_hxsa,
			    0x7fffffff); //RAMW32	8100	7fffffff
		RamWrite32A(HallFilterCoeffX_hxsb,
			    0x00000000); //RAMW32	80F8	00000000
		RamWrite32A(HallFilterCoeffX_hxsc,
			    0x00000000); //RAMW32	80FC	00000000
		RamWrite32A(HallFilterCoeffX_hxoa,
			    0x7fffffff); //RAMW32	8114	7fffffff
		RamWrite32A(HallFilterCoeffX_hxob,
			    0x00000000); //RAMW32	8104	00000000
		RamWrite32A(HallFilterCoeffX_hxoc,
			    0x00000000); //RAMW32	8108	00000000
		RamWrite32A(HallFilterCoeffX_hxod,
			    0x00000000); //RAMW32	810C	00000000
		RamWrite32A(HallFilterCoeffX_hxoe,
			    0x00000000); //RAMW32	8110	00000000
		RamWrite32A(HallFilterCoeffX_hxpa,
			    0x7fffffff); //RAMW32	8128	7fffffff
		RamWrite32A(HallFilterCoeffX_hxpb,
			    0x00000000); //RAMW32	8118	00000000
		RamWrite32A(HallFilterCoeffX_hxpc,
			    0x00000000); //RAMW32	811C	00000000
		RamWrite32A(HallFilterCoeffX_hxpd,
			    0x00000000); //RAMW32	8120	00000000
		RamWrite32A(HallFilterCoeffX_hxpe,
			    0x00000000); //RAMW32	8124	00000000
		...
		RamRead32A((HallFilterShiftY + 4) & 0xFFFE,
			   &BackupParameter[6]);
		...
		RamWrite32A(HallFilterCoeffY_hydgain0,
			    0x00000000); //RAMW32	8188	00000000
		RamWrite32A(HallFilterCoeffY_hypgain0,
			    0x7fffffff); //RAMW32	8174	7fffffff
		RamWrite32A(HallFilterCoeffY_hypgain1,
			    0x7fffffff); //RAMW32	8180	7fffffff
		RamWrite32A(HallFilterCoeffY_hyigain0,
			    0x00000000); //RAMW32	8184	00000000
		RamWrite32A(HallFilterCoeffY_hygain0,
			    0x7fffffff); //RAMW32	818C	7fffffff
		if (Info.Model == 0x01) { // KW
			RamWrite32A(
				(HallFilterShiftY & 0xFFFE),
				0x00010000); //RAMW32	8200	00000000
		} else {
			RamWrite32A(
				(HallFilterShiftY & 0xFFFE),
				0x00000000); //RAMW32	8200	00000000
		}
		RamWrite32A((HallFilterShiftY + 4) & 0xFFFE,
			    0x00000000); //RAMW32	8200	00000000
		RamWrite32A(HallFilterCoeffY_hysa,
			    0x7fffffff); //RAMW32	819C	7fffffff
		RamWrite32A(HallFilterCoeffY_hysb,
			    0x00000000); //RAMW32	8194	00000000
		RamWrite32A(HallFilterCoeffY_hysc,
			    0x00000000); //RAMW32	8198	00000000
		RamWrite32A(HallFilterCoeffY_hyoa,
			    0x7fffffff); //RAMW32	81B0	7fffffff
		RamWrite32A(HallFilterCoeffY_hyob,
			    0x00000000); //RAMW32	81A0	00000000
		RamWrite32A(HallFilterCoeffY_hyoc,
			    0x00000000); //RAMW32	81A4	00000000
		RamWrite32A(HallFilterCoeffY_hyod,
			    0x00000000); //RAMW32	81A8	00000000
		RamWrite32A(HallFilterCoeffY_hyoe,
			    0x00000000); //RAMW32	81AC	00000000
		RamWrite32A(HallFilterCoeffY_hypa,
			    0x7fffffff); //RAMW32	81C4	7fffffff
		RamWrite32A(HallFilterCoeffY_hypb,
			    0x00000000); //RAMW32	81B4	00000000
		RamWrite32A(HallFilterCoeffY_hypc,
			    0x00000000); //RAMW32	81B8	00000000
		RamWrite32A(HallFilterCoeffY_hypd,
			    0x00000000); //RAMW32	81BC	00000000
		RamWrite32A(HallFilterCoeffY_hype,
			    0x00000000); //RAMW32	81C0	00000000
...
UINT_32 Freq_Convert(float SfFreq)
{
	...
	UlPhsStep = (UINT_32)((SfFreq * (float)0x100000000 / FS_FREQ + 0.5F) /
			      2.0F);
...
void MesStart_FRA_Single(UINT_8 UcDirSel)
{
	...
	RamWrite32A(
		SinWave_Offset,
		Freq_Convert(
			StFRAParam.StHostCom.SfFrqCom
				.SfFltVal)); // Freq Setting = Freq * 80000000h / Fs	: 10Hz

	SfTmp = StFRAParam.StHostCom.SfAmpCom.SfFltVal /
		1400.0F; // AVDD 2800mV / 2 = 1400mV
	RamWrite32A(SinWave_Gain,
		    (UINT_32)((float)0x7FFFFFFF * SfTmp)); // Set Sine Wave Gain
	...
	if (StFRAParam.StHostCom.UcAvgCycl == 10) { // Actuator Through
		...
		if (UcDirSel == X_DIR) {
			SetTransDataAdr(
				SinWave_OutAddr,
				(UINT_32)HALL_RAM_SINDX1); // Set Sine Wave Input RAM
			// Set parameter and input/output address
			...
			SetTransDataAdr(
				SinWave_OutAddr,
				(UINT_32)HALL_RAM_SINDY1); // Set Sine Wave Input RAM
			// Set parameter and input/output address
	...
	TRACE("Phase %f deg : Gain %f dB\n", StFRAParam.StMesRslt.SfPhaseAvg,
...
void MesStart_FRA_Continue(void)
{
	...
	RamWrite32A(SinWave_Offset,
		    Freq_Convert(StFRAParam.StHostCom.SfFrqCom.SfFltVal));
	// Set parameter
	CoeffGenerate(StFRAParam.StHostCom.SfFrqCom.SfFltVal);
	//	WitTim(10)
	// Start to measure
