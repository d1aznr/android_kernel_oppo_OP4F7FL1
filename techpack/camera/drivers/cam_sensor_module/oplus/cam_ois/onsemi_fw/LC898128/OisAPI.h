...
__OIS_CMD_HEADER__ UINT_8
	RdStatus(UINT_8); //!< Status Read whether initialization finish or not.
...
OisEnaNCL(void); //!< OIS Enable function w/o delay clear
__OIS_CMD_HEADER__ void OisPause(void); //!< OIS disable function w/ pause

/* Others [option] */
__OIS_CMD_HEADER__
	UINT_8 RtnCen(UINT_8); //!< Return to center function. Hall servo on/off
__OIS_CMD_HEADER__ void
OisEnaDrCl(void); //!< OIS Enable function force drift cancel
__OIS_CMD_HEADER__ void OisEnaDrNcl(
	void); //!< OIS Enable function w/o delay clear and force drift cancel
...
__OIS_CMD_HEADER__ void
	SetPanTiltMode(UINT_8); //!< Pan/Tilt control (default ON)
...
__OIS_CMD_HEADER__ UINT_8 MesRam(INT_32, INT_32, INT_32, stMesRam *,
				 stMesRam *);
...
__OIS_CMD_HEADER__
	UINT_8 WrGyroGainData(UINT_8); //!< upload the gyro gain to Flash
__OIS_CMD_HEADER__ UINT_8
WrMixingData(void); //!< Flash Write Mixing Data Function
...
#ifdef HF_MIXING_ENA
__OIS_CMD_HEADER__ INT_8 WrMixCalData(
	UINT_8, mlMixingValue *); //!< upload the mixing coefficient to Flash
#endif // HF_MIXING_ENA
__OIS_CMD_HEADER__ UINT_8
WrAclOffsetData(void); //!< accelerator offset and matrix to Flash

__OIS_CMD_HEADER__ UINT_8 WrLinCalData(UINT_8, mlLinearityValue *);
__OIS_CMD_HEADER__ UINT_8 WrLinMixCalData(UINT_8, mlMixingValue *,
					  mlLinearityValue *);
__OIS_CMD_HEADER__ UINT_32 MeasGain(UINT_16, UINT_16, UINT_32);
__OIS_CMD_HEADER__ UINT_8 WrLinMix2ndCalData(UINT_8, mlMixingValue *,
					     mlLinearityValue *, stCrsPoint *);
...
/* Flash Update */
__OIS_FLSH_HEADER__ UINT_8
UnlockCodeSet(void); //!< <Flash Memory> Unlock Code Set
__OIS_FLSH_HEADER__ UINT_8
UnlockCodeClear(void); //!< <Flash Memory> Clear Unlock Code
