...
// History			: First edition
//********************************************************************************
unsigned char DownloadToEP3(const UINT8 *DataPM, UINT32 LengthPM, UINT32 Parity,
			    const UINT8 *DataDM, UINT32 LengthDMA,
			    UINT32 LengthDMB)
{
	UINT32 i, j;
	...
	UINT32 ReadVerifyPM = 0, ReadVerifyDMA = 0,
	       ReadVerifyDMB = 0; // Checksum
	UINT32 VerifySUM = 0;
	...
	if (VerifySUM == Parity) {
		CAM_ERR(CAM_OIS,
			"verify success. ReadVerifyPM=0x%x, ReadVerifyDMA=0x%x, ReadVerifyDMB=0x%x, VerifySUM=0x%x, Parity=0x%x",
			ReadVerifyPM, ReadVerifyDMA, ReadVerifyDMB, VerifySUM,
			Parity);
	} else {
		CAM_ERR(CAM_OIS,
			"verify fail. ReadVerifyPM=0x%x, ReadVerifyDMA=0x%x, ReadVerifyDMB=0x%x, VerifySUM=0x%x, Parity=0x%x",
			ReadVerifyPM, ReadVerifyDMA, ReadVerifyDMB, VerifySUM,
			Parity);
		return (2);
	}
...
// History			: First edition
//********************************************************************************
UINT8 GetInfomationBeforeDownload(DSPVER *Info, const UINT8 *DataDM,
				  UINT32 LengthDM)
{
	UINT32 i;
	Info->ActType = 0;
...
#if ((((SELECT_VENDOR & 0x01) == 0x01) || ((SELECT_VENDOR & 0x80) == 0x80)) && \
     (SELECT_MODEL == 0x00)) // SEMCO or Oplus
	{ 0x0002, 1, LC898124EP3_PM_0_1_0_2_2_0, LC898124EP3_PMSize_0_1_0_2_2_0,
	  (UINT32)((UINT32)LC898124EP3_PMCheckSum_0_1_0_2_2_0 +
		   (UINT32)LC898124EP3_DMA_CheckSum_0_1_0_2_2_0 +
		   (UINT32)LC898124EP3_DMB_CheckSum_0_1_0_2_2_0),
	  LC898124EP3_DM_0_1_0_2_2_0, LC898124EP3_DMA_ByteSize_0_1_0_2_2_0,
	  LC898124EP3_DMB_ByteSize_0_1_0_2_2_0 },
	{ 0x0082, 1, LC898124EP3_PM_0_1_0_2_2_1, LC898124EP3_PMSize_0_1_0_2_2_1,
	  (UINT32)((UINT32)LC898124EP3_PMCheckSum_0_1_0_2_2_1 +
		   (UINT32)LC898124EP3_DMA_CheckSum_0_1_0_2_2_1 +
		   (UINT32)LC898124EP3_DMB_CheckSum_0_1_0_2_2_1),
	  LC898124EP3_DM_0_1_0_2_2_1, LC898124EP3_DMA_ByteSize_0_1_0_2_2_1,
	  LC898124EP3_DMB_ByteSize_0_1_0_2_2_1 },
#endif
#if ((((SELECT_VENDOR & 0x01) == 0x01) || ((SELECT_VENDOR & 0x80) == 0x80)) && \
     (SELECT_MODEL == 0x01)) // SEMCO or Oplus
	{ 0x0002, 1, LC898124EP3_PM_1_1_0_2_2_0, LC898124EP3_PMSize_1_1_0_2_2_0,
	  (UINT32)((UINT32)LC898124EP3_PMCheckSum_1_1_0_2_2_0 +
		   (UINT32)LC898124EP3_DMA_CheckSum_1_1_0_2_2_0 +
		   (UINT32)LC898124EP3_DMB_CheckSum_1_1_0_2_2_0),
	  LC898124EP3_DM_1_1_0_2_2_0, LC898124EP3_DMA_ByteSize_1_1_0_2_2_0,
	  LC898124EP3_DMB_ByteSize_1_1_0_2_2_0 },
	{ 0x0082, 1, LC898124EP3_PM_1_1_0_2_2_1, LC898124EP3_PMSize_1_1_0_2_2_1,
	  (UINT32)((UINT32)LC898124EP3_PMCheckSum_1_1_0_2_2_1 +
		   (UINT32)LC898124EP3_DMA_CheckSum_1_1_0_2_2_1 +
		   (UINT32)LC898124EP3_DMB_CheckSum_1_1_0_2_2_1),
	  LC898124EP3_DM_1_1_0_2_2_1, LC898124EP3_DMA_ByteSize_1_1_0_2_2_1,
	  LC898124EP3_DMB_ByteSize_1_1_0_2_2_1 },
#endif
#if ((((SELECT_VENDOR & 0x01) == 0x01) || ((SELECT_VENDOR & 0x80) == 0x80)) && \
     (SELECT_MODEL == 0x02)) // SEMCO or Oplus
	{ 0x0003, 1, LC898124EP3_PM_2_1_0_3_2_0, LC898124EP3_PMSize_2_1_0_3_2_0,
	  (UINT32)((UINT32)LC898124EP3_PMCheckSum_2_1_0_3_2_0 +
		   (UINT32)LC898124EP3_DMA_CheckSum_2_1_0_3_2_0 +
		   (UINT32)LC898124EP3_DMB_CheckSum_2_1_0_3_2_0),
	  LC898124EP3_DM_2_1_0_3_2_0, LC898124EP3_DMA_ByteSize_2_1_0_3_2_0,
	  LC898124EP3_DMB_ByteSize_2_1_0_3_2_0 },
	{ 0x0083, 1, LC898124EP3_PM_2_1_0_3_2_1, LC898124EP3_PMSize_2_1_0_3_2_1,
	  (UINT32)((UINT32)LC898124EP3_PMCheckSum_2_1_0_3_2_1 +
		   (UINT32)LC898124EP3_DMA_CheckSum_2_1_0_3_2_1 +
		   (UINT32)LC898124EP3_DMB_CheckSum_2_1_0_3_2_1),
	  LC898124EP3_DM_2_1_0_3_2_1, LC898124EP3_DMA_ByteSize_2_1_0_3_2_1,
	  LC898124EP3_DMB_ByteSize_2_1_0_3_2_1 },
#endif
#if (((SELECT_VENDOR & 0x02) == 0x02) ||                                       \
     ((SELECT_VENDOR & 0x80) == 0x80)) // OFILM or Oplus
	{ 0x0102, 1, LC898124EP3_PM_1_2_1_2_2_0, LC898124EP3_PMSize_1_2_1_2_2_0,
	  (UINT32)((UINT32)LC898124EP3_PMCheckSum_1_2_1_2_2_0 +
		   (UINT32)LC898124EP3_DMA_CheckSum_1_2_1_2_2_0 +
		   (UINT32)LC898124EP3_DMB_CheckSum_1_2_1_2_2_0),
	  LC898124EP3_DM_1_2_1_2_2_0, LC898124EP3_DMA_ByteSize_1_2_1_2_2_0,
	  LC898124EP3_DMB_ByteSize_1_2_1_2_2_0 },
	{ 0x0182, 1, LC898124EP3_PM_1_2_1_2_2_1, LC898124EP3_PMSize_1_2_1_2_2_1,
	  (UINT32)((UINT32)LC898124EP3_PMCheckSum_1_2_1_2_2_1 +
		   (UINT32)LC898124EP3_DMA_CheckSum_1_2_1_2_2_1 +
		   (UINT32)LC898124EP3_DMB_CheckSum_1_2_1_2_2_1),
	  LC898124EP3_DM_1_2_1_2_2_1, LC898124EP3_DMA_ByteSize_1_2_1_2_2_1,
	  LC898124EP3_DMB_ByteSize_1_2_1_2_2_1 },
#endif
	{ 0xFFFF, 0, (void *)0, 0, 0, (void *)0, 0, 0 }
};

unsigned char SelectDownload(UINT8 GyroSelect, UINT8 ActSelect,
			     UINT8 MasterSlave, UINT8 FWType)
{
	DSPVER Dspcode;
	DOWNLOAD_TBL *ptr = NULL;
	CAM_INFO(
		CAM_OIS,
		"GyroSelect:0x%x, ActSelect:0x%x, MasterSlave:0x%x, FWType:%d\n",
	...
	while (ptr->Cmd != 0xFFFF) {
		if ((ptr->Cmd == (((uint16_t)ActSelect << 8) + GyroSelect)) &&
		    (ptr->FWType == FWType))
			break;
		ptr++;
	}
	...
	if (GetInfomationBeforeDownload(&Dspcode, ptr->DataDM,
					(ptr->LengthDMA + ptr->LengthDMB)) !=
	    0) {
		return (0xF1);
	}

	/* Downloadする前のCodeと、要求しているActuator/Gyro情報が一致しているか確認 */
	if ((ActSelect != Dspcode.ActType) ||
	    ((GyroSelect & 0x7f) != Dspcode.GyroType))
		return (0xF2);
	...
	TRACE("DataPM( %08x ), LengthPM( %08x ) , Parity( %08x ), DataDM( %08x ) , LengthDMA( %08x ) , LengthDMB( %08x ) \n",
	      ...
	      (int)ptr->DataDM, (int)ptr->LengthDMA, (int)ptr->LengthDMB);
	return (DownloadToEP3(ptr->DataPM, ptr->LengthPM, ptr->Parity,
