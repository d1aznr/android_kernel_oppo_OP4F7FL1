...
unsigned char UnlockCodeSet124(void)
{
	...
	DMIOWrite32(E2P_UNLK_CODE1,
		    0xAAAAAAAA); // UNLK_CODE1(E0_7554h) = AAAA_AAAAh
	DMIOWrite32(E2P_UNLK_CODE2,
		    0x55555555); // UNLK_CODE2(E0_7AA8h) = 5555_5555h
...
unsigned char WriteE2Prom(unsigned char address, unsigned char data)
{
	...
	switch ((address & 0x0F)) {
	case 0:
		DMIOWrite32(E2P_WDAT00, data);
		break;
	case 1:
		DMIOWrite32(E2P_WDAT01, data);
		break;
	case 2:
		DMIOWrite32(E2P_WDAT02, data);
		break;
	case 3:
		DMIOWrite32(E2P_WDAT03, data);
		break;
	case 4:
		DMIOWrite32(E2P_WDAT04, data);
		break;
	case 5:
		DMIOWrite32(E2P_WDAT05, data);
		break;
	case 6:
		DMIOWrite32(E2P_WDAT06, data);
		break;
	case 7:
		DMIOWrite32(E2P_WDAT07, data);
		break;
	case 8:
		DMIOWrite32(E2P_WDAT08, data);
		break;
	case 9:
		DMIOWrite32(E2P_WDAT09, data);
		break;
	case 10:
		DMIOWrite32(E2P_WDAT10, data);
		break;
	case 11:
		DMIOWrite32(E2P_WDAT11, data);
		break;
	case 12:
		DMIOWrite32(E2P_WDAT12, data);
		break;
	case 13:
		DMIOWrite32(E2P_WDAT13, data);
		break;
	case 14:
		DMIOWrite32(E2P_WDAT14, data);
		break;
	case 15:
		DMIOWrite32(E2P_WDAT15, data);
		break;
	}
...
// History			: First edition
//********************************************************************************
void BurstReadE2Prom(unsigned char address, unsigned char *val,
		     unsigned char cnt)
{
	UINT32 UlReadVal;
	unsigned char i;
...
UINT8 E2PromVerificationONSEMI(void)
{
	...
	if ((UINT8)Verify != temp[(E2P_ONSEMI_AREA_SIZE - 1)])
		return (FAILURE);
...
UINT8 E2PromVerification(void)
{
	...
	if ((UINT8)Verify != temp[(E2P_USER_AREA_SIZE - 1)])
		return (FAILURE);
	return (SUCCESS);
}
...
UINT8 WrHallCalData124(void)
{
	...
	StAdjPar124.StHalAdj.UlAdjPhs |=
		((((UINT32)UcReadVal[1] << 8) + UcReadVal[0]) &
		 (~(HALL_CALB_FLG | HALL_CALB_BIT)));
	...
	DMIOWrite32(E2P_WDAT08, (UINT8)((StAdjPar124.StHalAdj.UlAdjPhs) >>
					LSB)); // Calibration Status
	DMIOWrite32(E2P_WDAT09,
		    (UINT8)((StAdjPar124.StHalAdj.UlAdjPhs) >> MSB));
	DMIOWrite32(E2P_WDAT10, (UINT8)((StAdjPar124.StHalAdj.UsHlxMxa) >>
					LSB)); // OIS Hall X Max After
	DMIOWrite32(E2P_WDAT11,
		    (UINT8)((StAdjPar124.StHalAdj.UsHlxMxa) >> MSB));
	DMIOWrite32(E2P_WDAT12, (UINT8)((StAdjPar124.StHalAdj.UsHlxMna) >>
					LSB)); // OIS Hall X Min After
	DMIOWrite32(E2P_WDAT13,
		    (UINT8)((StAdjPar124.StHalAdj.UsHlxMna) >> MSB));
	DMIOWrite32(E2P_WDAT14, (UINT8)((StAdjPar124.StHalAdj.UsHlyMxa) >>
					LSB)); // OIS Hall Y Max After
	DMIOWrite32(E2P_WDAT15,
		    (UINT8)((StAdjPar124.StHalAdj.UsHlyMxa) >> MSB));
	...
	DMIOWrite32(E2P_WDAT00, (UINT8)((StAdjPar124.StHalAdj.UsHlyMna) >>
					LSB)); // OIS Hall Y Min After
	DMIOWrite32(E2P_WDAT01,
		    (UINT8)((StAdjPar124.StHalAdj.UsHlyMna) >> MSB));
	DMIOWrite32(E2P_WDAT02, (UINT8)((StAdjPar124.StHalAdj.UsHlxGan) >>
					8)); // OIS Hall Bias X
	DMIOWrite32(E2P_WDAT03, (UINT8)((StAdjPar124.StHalAdj.UsHlxOff) >>
					8)); // OIS Hall Offset X
	DMIOWrite32(E2P_WDAT04, (UINT8)((StAdjPar124.StHalAdj.UsHlyGan) >>
					8)); // OIS Hall Bias Y
	DMIOWrite32(E2P_WDAT05, (UINT8)((StAdjPar124.StHalAdj.UsHlyOff) >>
					8)); // OIS Hall Offset Y
	DMIOWrite32(E2P_WDAT06, (UINT8)((StAdjPar124.StLopGan.UlLxgVal) >>
					16)); // OIS Hall Loop Gain X
	DMIOWrite32(E2P_WDAT07, (UINT8)((StAdjPar124.StLopGan.UlLxgVal) >>
					24)); // OIS Hall Loop Gain X
	DMIOWrite32(E2P_WDAT08, (UINT8)((StAdjPar124.StLopGan.UlLygVal) >>
					16)); // OIS Hall Loop Gain Y
	DMIOWrite32(E2P_WDAT09, (UINT8)((StAdjPar124.StLopGan.UlLygVal) >> 24));
	DMIOWrite32(E2P_WDAT10, (UINT8)((StAdjPar124.StHalAdj.UsAdxOff) >>
					LSB)); // OIS Mecha center X
	DMIOWrite32(E2P_WDAT11,
		    (UINT8)((StAdjPar124.StHalAdj.UsAdxOff) >> MSB));
	DMIOWrite32(E2P_WDAT12, (UINT8)((StAdjPar124.StHalAdj.UsAdyOff) >>
					LSB)); // OIS Mecha center Y
	DMIOWrite32(E2P_WDAT13,
		    (UINT8)((StAdjPar124.StHalAdj.UsAdyOff) >> MSB));
...
UINT8 WrGyroGainData124(void)
{
	...
	BurstReadE2Prom(EEPROM_Calibration_Status_LSB, UcReadVal, 2);
	UlReadVal =
		(((UINT32)UcReadVal[1] << 8) + UcReadVal[0]) & (~GYRO_GAIN_FLG);
	...
	DMIOWrite32(E2P_WDAT08,
		    (UINT8)((UlReadVal) >> LSB)); // Calibration Status
	...
	DMIOWrite32(E2P_WDAT02,
		    (UINT8)(UlZoomY >> 0)); //	GyroFilterTableY_gyzoom
...
UINT8 WrZeroServoData(void)
{
	...
	BurstReadE2Prom(EEPROM_Calibration_Status_LSB, UcReadVal, 2);
	UlReadVal =
		(((UINT32)UcReadVal[1] << 8) + UcReadVal[0]) & (~ZSRV_CAL_FLG);
	...
	DMIOWrite32(E2P_WDAT06,
		    (UINT8)(((StZeroServoX.SlOffset) >> 16) >> LSB));
	DMIOWrite32(E2P_WDAT07,
		    (UINT8)(((StZeroServoX.SlOffset) >> 16) >> MSB));
	...
	DMIOWrite32(E2P_WDAT15,
		    (UINT8)(((StZeroServoY.SlOffset) >> 16) >> MSB));
	...
	DMIOWrite32(E2P_WDAT06,
		    (UINT8)(((StZeroServoZ.SlOffset) >> 16) >> LSB));
	DMIOWrite32(E2P_WDAT07,
		    (UINT8)(((StZeroServoZ.SlOffset) >> 16) >> MSB));
...
UINT8 WrHallLnData(UINT8 UcMode, mlLinearityValue *linval)
{
	...
	BurstReadE2Prom(EEPROM_Calibration_Status_LSB, UcReadVal, 2);
	if (UcMode) {
		UlReadVal = (((UINT32)UcReadVal[1] << 8) + UcReadVal[0]) &
			    (~HLLN_CALB_FLG);
	} else {
		UlReadVal = (((UINT32)UcReadVal[1] << 8) + UcReadVal[0]) |
			    (HLLN_CALB_FLG);
	...
	if (UcMode) {
		...
		DMIOWrite32(E2P_WDAT08,
			    (UINT8)((UINT32)(*pPosX * 10) >> LSB)); // POS1 X
		DMIOWrite32(E2P_WDAT09, (UINT8)((UINT32)(*pPosX * 10) >> MSB));
		pPosX++;
		DMIOWrite32(E2P_WDAT10,
			    (UINT8)((UINT32)(*pPosY * 10) >> LSB)); // POS1 Y
		DMIOWrite32(E2P_WDAT11, (UINT8)((UINT32)(*pPosY * 10) >> MSB));
		pPosY++;
		DMIOWrite32(E2P_WDAT12,
			    (UINT8)((UINT32)(*pPosX * 10) >> LSB)); // POS2 X
		DMIOWrite32(E2P_WDAT13, (UINT8)((UINT32)(*pPosX * 10) >> MSB));
		pPosX++;
		DMIOWrite32(E2P_WDAT14,
			    (UINT8)((UINT32)(*pPosY * 10) >> LSB)); // POS2 Y
		DMIOWrite32(E2P_WDAT15, (UINT8)((UINT32)(*pPosY * 10) >> MSB));
		pPosY++;
	} else {
	...
	if (UcMode) {
		DMIOWrite32(E2P_WDAT00,
			    (UINT8)((UINT32)(*pPosX * 10) >> LSB)); // POS3 X
		DMIOWrite32(E2P_WDAT01, (UINT8)((UINT32)(*pPosX * 10) >> MSB));
		pPosX++;
		DMIOWrite32(E2P_WDAT02,
			    (UINT8)((UINT32)(*pPosY * 10) >> LSB)); // POS3 Y
		DMIOWrite32(E2P_WDAT03, (UINT8)((UINT32)(*pPosY * 10) >> MSB));
		pPosY++;
		DMIOWrite32(E2P_WDAT04,
			    (UINT8)((UINT32)(*pPosX * 10) >> LSB)); // POS4 X
		DMIOWrite32(E2P_WDAT05, (UINT8)((UINT32)(*pPosX * 10) >> MSB));
		pPosX++;
		DMIOWrite32(E2P_WDAT06,
			    (UINT8)((UINT32)(*pPosY * 10) >> LSB)); // POS4 Y
		DMIOWrite32(E2P_WDAT07, (UINT8)((UINT32)(*pPosY * 10) >> MSB));
		pPosY++;
		DMIOWrite32(E2P_WDAT08,
			    (UINT8)((UINT32)(*pPosX * 10) >> LSB)); // POS5 X
		DMIOWrite32(E2P_WDAT09, (UINT8)((UINT32)(*pPosX * 10) >> MSB));
		pPosX++;
		DMIOWrite32(E2P_WDAT10,
			    (UINT8)((UINT32)(*pPosY * 10) >> LSB)); // POS5 Y
		DMIOWrite32(E2P_WDAT11, (UINT8)((UINT32)(*pPosY * 10) >> MSB));
		pPosY++;
		DMIOWrite32(E2P_WDAT12,
			    (UINT8)((UINT32)(*pPosX * 10) >> LSB)); // POS6 X
		DMIOWrite32(E2P_WDAT13, (UINT8)((UINT32)(*pPosX * 10) >> MSB));
		pPosX++;
		DMIOWrite32(E2P_WDAT14,
			    (UINT8)((UINT32)(*pPosY * 10) >> LSB)); // POS6 Y
		DMIOWrite32(E2P_WDAT15, (UINT8)((UINT32)(*pPosY * 10) >> MSB));
		pPosY++;
	} else {
	...
	if (UcMode) {
		DMIOWrite32(E2P_WDAT00,
			    (UINT8)((UINT32)(*pPosX * 10) >> LSB)); // POS7 X
		DMIOWrite32(E2P_WDAT01, (UINT8)((UINT32)(*pPosX * 10) >> MSB));
		DMIOWrite32(E2P_WDAT02,
			    (UINT8)((UINT32)(*pPosY * 10) >> LSB)); // POS7 Y
		DMIOWrite32(E2P_WDAT03, (UINT8)((UINT32)(*pPosY * 10) >> MSB));
		...
		DMIOWrite32(E2P_WDAT04,
			    (UINT8)((UINT16)(PosDifX >> 16) >> LSB)); // STEP X
		DMIOWrite32(E2P_WDAT05,
			    (UINT8)((UINT16)(PosDifX >> 16) >> MSB));
		DMIOWrite32(E2P_WDAT06,
			    (UINT8)((UINT16)(PosDifY >> 16) >> LSB)); // STEP Y
		DMIOWrite32(E2P_WDAT07,
			    (UINT8)((UINT16)(PosDifY >> 16) >> MSB));
	} else {
...
UINT8 WrMixCalData124(UINT8 UcMode, mlMixingValue *mixval)
{
	...
	if (UcMode) {
		if (Info.ActType == ACT_SO2821) {
			/* XYSWAP == 0 */
			DMIOWrite32(E2P_WDAT08,
				    (UINT8)((mixval->hx45xL >> 16) >> LSB));
			DMIOWrite32(E2P_WDAT09,
				    (UINT8)((mixval->hx45xL >> 16) >> MSB));
			DMIOWrite32(E2P_WDAT10,
				    (UINT8)((mixval->hx45yL >> 16) >> LSB));
			DMIOWrite32(E2P_WDAT11,
				    (UINT8)((mixval->hx45yL >> 16) >> MSB));
			DMIOWrite32(E2P_WDAT12,
				    (UINT8)((mixval->hy45yL >> 16) >> LSB));
			DMIOWrite32(E2P_WDAT13,
				    (UINT8)((mixval->hy45yL >> 16) >> MSB));
			DMIOWrite32(E2P_WDAT14,
				    (UINT8)((mixval->hy45xL >> 16) >> LSB));
			DMIOWrite32(E2P_WDAT15,
				    (UINT8)((mixval->hy45xL >> 16) >> MSB));
		} else {
			/* XYSWAP == 0 */
			DMIOWrite32(E2P_WDAT08,
				    (UINT8)((mixval->hx45xL >> 16) >> LSB));
...
UINT8 WrOptOffsetData(void)
{
	...
	DMIOWrite32(E2P_WDAT02,
		    (UINT8)((UlHxoff) >> (16 + LSB))); // optical center X
	DMIOWrite32(E2P_WDAT03, (UINT8)((UlHxoff) >> (16 + MSB)));
	DMIOWrite32(E2P_WDAT04,
		    (UINT8)((UlHyoff) >> (16 + LSB))); // optical center Y
