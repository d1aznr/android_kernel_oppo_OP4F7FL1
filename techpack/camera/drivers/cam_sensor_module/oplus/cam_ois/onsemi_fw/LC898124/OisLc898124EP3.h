...
#define StMeasFunc_MFA_LLiIntegral1                                            \
	(0x0004 + StMeasFunc_MFA_UiDUMMY1) // 0x0418	// 8Byte
#define StMeasFunc_MFA_LLiAbsInteg1                                            \
	(0x0008 + StMeasFunc_MFA_LLiIntegral1) // 0x0420	// 8Byte
#define StMeasFunc_MFA_PiMeasureRam1                                           \
	(0x0008 + StMeasFunc_MFA_LLiAbsInteg1) // 0x0428
#define StMeasFunc_MFA_UiDUMMY2                                                \
	(0x0004 + StMeasFunc_MFA_PiMeasureRam1) // 0x042C
...
#define StMeasFunc_MFB_LLiIntegral2                                            \
	(0x0004 + StMeasFunc_MFB_UiDUMMY1) // 0x0440	// 8Byte
#define StMeasFunc_MFB_LLiAbsInteg2                                            \
	(0x0008 + StMeasFunc_MFB_LLiIntegral2) // 0x0448	// 8Byte
#define StMeasFunc_MFB_PiMeasureRam2                                           \
	(0x0008 + StMeasFunc_MFB_LLiAbsInteg2) // 0x0450
...
#define WaitTimerData_UiTargetCount                                            \
	(0x0004 + WaitTimerData_UiWaitCounter) // 0x04B0
#define WaitTimerData_UiBaseCount                                              \
	(0x0004 + WaitTimerData_UiTargetCount) // 0x04B4
...
#define ZeroServoFilterTableX_coeff1_0                                         \
	(0x0000 + ZeroServoFilterTableX) // 0x8384
#define ZeroServoFilterTableX_coeff1_1                                         \
	(0x0004 + ZeroServoFilterTableX_coeff1_0) // 0x8388
#define ZeroServoFilterTableX_coeff1_2                                         \
	(0x0004 + ZeroServoFilterTableX_coeff1_1) // 0x838C
#define ZeroServoFilterTableX_g45main                                          \
	(0x0004 + ZeroServoFilterTableX_coeff1_2) // 0x8390
#define ZeroServoFilterTableX_g45sub                                           \
	(0x0004 + ZeroServoFilterTableX_g45main) // 0x8394
#define ZeroServoFilterTableX_gcora                                            \
	(0x0004 + ZeroServoFilterTableX_g45sub) // 0x8398
#define ZeroServoFilterTableX_gaina                                            \
	(0x0004 + ZeroServoFilterTableX_gcora) // 0x839C
#define ZeroServoFilterTableX_shift                                            \
	(0x0004 + ZeroServoFilterTableX_gaina) // 0x83A0

#define ZeroServoFilterTableY 0x83A4
#define ZeroServoFilterTableY_coeff1_0                                         \
	(0x0000 + ZeroServoFilterTableY) // 0x83A4
#define ZeroServoFilterTableY_coeff1_1                                         \
	(0x0004 + ZeroServoFilterTableY_coeff1_0) // 0x83A8
#define ZeroServoFilterTableY_coeff1_2                                         \
	(0x0004 + ZeroServoFilterTableY_coeff1_1) // 0x83AC
#define ZeroServoFilterTableY_g45main                                          \
	(0x0004 + ZeroServoFilterTableY_coeff1_2) // 0x83B0
#define ZeroServoFilterTableY_g45sub                                           \
	(0x0004 + ZeroServoFilterTableY_g45main) // 0x83B4
#define ZeroServoFilterTableY_gcora                                            \
	(0x0004 + ZeroServoFilterTableY_g45sub) // 0x83B8
#define ZeroServoFilterTableY_gaina                                            \
	(0x0004 + ZeroServoFilterTableY_gcora) // 0x83BC
#define ZeroServoFilterTableY_shift                                            \
	(0x0004 + ZeroServoFilterTableY_gaina) // 0x83C0
