...
static int cam_cpastop_poweron(struct cam_hw_info *cpas_hw)
{
	...
	cam_io_w_mb(0x2, soc_info->reg_map[reg_base_index].mem_base + 0x2D08);
	/* Update the cam_noc_amm_jpeg_qosgen_Shaping_Low  */
	cam_io_w_mb(0x8080808,
		    soc_info->reg_map[reg_base_index].mem_base + 0x2D20);
	/* Update the cam_noc_amm_jpeg_qosgen_Shaping_High	 */
	cam_io_w_mb(0x8080808,
		    soc_info->reg_map[reg_base_index].mem_base + 0x2D24);

	/* Update the ipe_0_rd_qosgen_MainCtl_Low  */
	cam_io_w_mb(0x2, soc_info->reg_map[reg_base_index].mem_base + 0x2208);
	/* Update the ipe_0_rd_qosgen_Shaping_Low	*/
	cam_io_w_mb(0x14141414,
		    soc_info->reg_map[reg_base_index].mem_base + 0x2220);
	/* Update the ipe_0_rd_qosgen_Shaping_High	 */
	cam_io_w_mb(0x14141414,
		    soc_info->reg_map[reg_base_index].mem_base + 0x2224);

	/* Update the ipe_1_bps_rd_qosgen_MainCtl_Low	*/
	cam_io_w_mb(0x2, soc_info->reg_map[reg_base_index].mem_base + 0x2308);
	/* Update the ipe_1_bps_rd_qosgen_Shaping_Low	 */
	cam_io_w_mb(0x14141414,
		    soc_info->reg_map[reg_base_index].mem_base + 0x2320);
	/* Update the ipe_1_bps_rd_qosgen_Shaping_High	  */
	cam_io_w_mb(0x14141414,
		    soc_info->reg_map[reg_base_index].mem_base + 0x2324);
#endif
	return 0;
}
