...
enum {
	...
	FOUR_BYTE_REG_LEN_READ =
		(MSMFB_IRIS_I2C_READ << 16) | FOUR_BYTE_REG_LEN,
	ONE_BYTE_REG_LEN_WRITE =
		(MSMFB_IRIS_I2C_WRITE << 16) | ONE_BYTE_REG_LEN,
	TWO_BYTE_REG_LEN_WRITE =
		(MSMFB_IRIS_I2C_WRITE << 16) | TWO_BYTE_REG_LEN,
	FOUR_BYTE_REG_LEN_WRITE =
		(MSMFB_IRIS_I2C_WRITE << 16) | FOUR_BYTE_REG_LEN,
};
