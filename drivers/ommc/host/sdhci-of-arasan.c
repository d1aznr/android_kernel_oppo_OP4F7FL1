 ...
 */
static int
sdhci_arasan_syscon_write(struct sdhci_host *host,
			  const struct sdhci_arasan_soc_ctl_field *fld, u32 val)
{
...
sdhci_arasan_sdcardclk_recalc_rate(struct clk_hw *hw, unsigned long parent_rate)
