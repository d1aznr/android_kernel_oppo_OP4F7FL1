...
#define ST_MMC_CCONFIG_3_DEFAULT                                               \
	(ST_MMC_CCONFIG_ASYNCH_INTR_SUPPORT | ST_MMC_CCONFIG_3P3_VOLT |        \
	 ST_MMC_CCONFIG_SUSP_RES_SUPPORT | ST_MMC_CCONFIG_SDMA)
...
#define ST_TOP_MMC_DYN_DLY_CONF                                                \
	(ST_TOP_MMC_DLY_CTRL_TX_DLL_ENABLE |                                   \
	 ST_TOP_MMC_DLY_CTRL_ATUNE_NOT_CFG_DLY | ST_TOP_MMC_START_DLL_LOCK)
