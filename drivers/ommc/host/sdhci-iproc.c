...
static const struct sdhci_pltfm_data sdhci_iproc_cygnus_pltfm_data = {
	.quirks =
		SDHCI_QUIRK_DATA_TIMEOUT_USES_SDCLK | SDHCI_QUIRK_NO_HISPD_BIT,
...
static const struct sdhci_iproc_data iproc_cygnus_data = {
	...
	.caps = ((0x1 << SDHCI_MAX_BLOCK_SHIFT) & SDHCI_MAX_BLOCK_MASK) |
...
static const struct sdhci_pltfm_data sdhci_iproc_pltfm_data = {
	.quirks = SDHCI_QUIRK_DATA_TIMEOUT_USES_SDCLK |
		  SDHCI_QUIRK_MULTIBLOCK_READ_ACMD12 | SDHCI_QUIRK_NO_HISPD_BIT,
...
static const struct sdhci_iproc_data bcm2835_data = {
	...
	.caps = ((0x1 << SDHCI_MAX_BLOCK_SHIFT) & SDHCI_MAX_BLOCK_MASK) |
		SDHCI_CAN_VDD_330 | SDHCI_CAN_DO_HISPD,
	.caps1 = SDHCI_DRIVER_TYPE_A | SDHCI_DRIVER_TYPE_C,
	.mmc_caps = 0x00000000,
};
