...
static void tegra_sdhci_reset(struct sdhci_host *host, u8 mask)
{
	...
	misc_ctrl &=
		~(SDHCI_MISC_CTRL_ENABLE_SDHCI_SPEC_300 |
		  SDHCI_MISC_CTRL_ENABLE_SDR50 | SDHCI_MISC_CTRL_ENABLE_DDR50 |
...
static const struct sdhci_tegra_soc_data soc_data_tegra20 = {
	...
	.nvquirks = NVQUIRK_FORCE_SDHCI_SPEC_200 | NVQUIRK_ENABLE_BLOCK_GAP_DET,
};
...
static const struct sdhci_tegra_soc_data soc_data_tegra30 = {
	...
	.nvquirks = NVQUIRK_ENABLE_SDHCI_SPEC_300 | NVQUIRK_ENABLE_SDR50 |
		    NVQUIRK_ENABLE_SDR104 | NVQUIRK_HAS_PADCALIB,
};
...
static int sdhci_tegra_probe(struct platform_device *pdev)
{
	...
	tegra_host->power_gpio =
		devm_gpiod_get_optional(&pdev->dev, "power", GPIOD_OUT_HIGH);
	...
	tegra_host->rst = devm_reset_control_get_exclusive(&pdev->dev, "sdhci");
