...
/* Enable this SDHC */
static void xenon_enable_sdhc(struct sdhci_host *host, unsigned char sdhc_id)
{
	u32 reg;
...
/* Disable this SDHC */
static void xenon_disable_sdhc(struct sdhci_host *host, unsigned char sdhc_id)
{
	u32 reg;
...
static void xenon_reset_exit(struct sdhci_host *host, unsigned char sdhc_id,
			     u8 mask)
{
...
static const struct dev_pm_ops sdhci_xenon_dev_pm_ops = {
	SET_SYSTEM_SLEEP_PM_OPS(xenon_suspend, pm_runtime_force_resume)
		SET_RUNTIME_PM_OPS(xenon_runtime_suspend, xenon_runtime_resume,
				   NULL)
};
