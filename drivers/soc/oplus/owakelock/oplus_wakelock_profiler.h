...
#if defined(CONFIG_OPPO_WAKELOCK_PROFILER) ||                                  \
	defined(CONFIG_OPLUS_WAKELOCK_PROFILER)
...
static inline int wakeup_reasons_statics(const char *irq_name, int choose_flag)
{
	return true;
}
