...
static struct wakeup_count_desc_t *const all_modules_trinket[] = {
	&wc_powerkey_trinket, &wc_rtc_alarm_trinket, &wc_alarm_trinket,
	&wc_modem_trinket,    &wc_wlan_trinket,	     &wc_adsp_trinket,
	&wc_cdsp_trinket,     &wc_slpi_trinket,	     &wc_glink_trinket,
	&wc_abort_trinket,    &wc_sum_trinket,	     NULL,
};
