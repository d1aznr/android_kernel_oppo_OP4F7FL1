...
static struct wakeup_count_desc_t *const all_modules_blair[] = {
	&wc_powerkey_blair, &wc_rtc_alarm_blair, &wc_alarm_blair,
	&wc_modem_blair,    &wc_wlan_blair,	 &wc_adsp_blair,
	&wc_cdsp_blair,	    &wc_slpi_blair,	 &wc_glink_blair,
	&wc_abort_blair,    &wc_sum_blair,	 NULL,
};
