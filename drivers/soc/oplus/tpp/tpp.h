...
struct tpp_task_sample {
	long long data[TPP_TASK_REPORT_SIZE]
		      [TPP_TASK_MONITOR_SIZE * TPP_TASK_COLUMN];
};
...
static inline int tpp_find_cpu(int cpu_orig, struct task_struct *p)
{
	return 0;
}
...
static inline int tpp_cluster_amount(void)
{
	return 0;
}
static inline int tpp_cpu_cmount_of_cluster(int cluster)
{
	return 0;
}
static inline int tpp_max_freq_of_cluster(int cluster)
{
	return 0;
}
static inline int tpp_first_cpu_of_cluster(int cluster)
{
	return 0;
}
static inline bool tpp_task(struct task_struct *p)
{
	return false;
}
