...
#define GAME_GET_CPU_LOAD _IOWR(GAME_CTRL_MAGIC, GET_CPU_LOAD, struct cpu_load)

#define GAME_SET_GAME_PID _IOWR(GAME_CTRL_MAGIC, SET_GAME_PID, struct game_pid)
