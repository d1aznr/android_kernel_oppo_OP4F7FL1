	...
	if (ts->pen_support) {
		...
		for (i = 0; i < ts->hw_res.pen_rx_num; i++) {
			...
			for (j = 0; j < ts->hw_res.TX_NUM; j++) {
				seq_printf(
					s, "%4d, ",
					pen_tip_x_data_P[i * ts->hw_res.TX_NUM +
							 j]);
			}
		}
		...
		for (i = 0; i < ts->hw_res.pen_rx_num; i++) {
			...
			for (j = 0; j < ts->hw_res.TX_NUM; j++) {
				seq_printf(
					s, "%4d, ",
					pen_tip_x_data_N[i * ts->hw_res.TX_NUM +
							 j]);
			}
		}
		...
		for (i = 0; i < ts->hw_res.pen_rx_num; i++) {
			...
			for (j = 0; j < ts->hw_res.TX_NUM; j++) {
				seq_printf(
					s, "%4d, ",
					pen_ring_x_data_P[i * ts->hw_res.TX_NUM +
							  j]);
			}
		}
		...
		for (i = 0; i < ts->hw_res.pen_rx_num; i++) {
			...
			for (j = 0; j < ts->hw_res.TX_NUM; j++) {
				seq_printf(
					s, "%4d, ",
					pen_ring_x_data_N[i * ts->hw_res.TX_NUM +
							  j]);
			}
		}
