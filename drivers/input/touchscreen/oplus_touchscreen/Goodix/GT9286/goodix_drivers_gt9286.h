...
#define set_reg_bit(reg, pos, val)                                             \
	((reg) = ((reg) & (~(1 << (pos)))) | (!!(val) << (pos)))

#define MAX_POINT_NUM 10 //max touch point number this ic support
#define MAX_GT_IRQ_DATA_LENGTH                                                 \
	90 //irq data(points,key,checksum) size read from irq
#define MAX_GESTURE_POINT_NUM 64 //max point number of black gesture

#define GTP_DRIVER_SEND_CFG                                                    \
	1 // send config to TP while initializing (for no config built in TP's flash)
...
u8 GTP_CFG_GROUP_SAMSUNG[] = {
	
};
