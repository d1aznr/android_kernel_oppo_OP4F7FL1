...
static char *test_item_name[MAX_TEST_ITEMS] = {
	"GTP_INTPIN_TEST",  "GTP_CAP_TEST",
	"GTP_DELTA_TEST",   "GTP_NOISE_TEST",
	"no test",	    "GTP_SHORT_TEST",
	"GTP_SELFCAP_TEST", "GTP_SELFNOISE_TEST",
	"no test",	    "no test",
};
...
#define GTX8_NORMAL_NOISE_CONFIG                                               \
	"normal_noise_config" //config_type: 0x02,normal sensitivity, use for charging
#define GTX8_GLOVE_CONFIG "glove_config" //config_type: 0x03,high sensitivity
#define GTX8_GLOVE_NOISE_CONFIG                                                \
	"glove_noise_config" //config_type: 0x04,high sensitivity, use for charging
#define GTX8_HOLSTER_CONFIG "holster_config" //config_type: 0x05,holster
#define GTX8_HOLSTER_NOISE_CONFIG                                              \
	"holster_noise_config" //config_type: 0x06,holster ,use for charging
#define GTX8_NOISE_TEST_CONFIG                                                 \
	"tpnoise_test_config" //config_type: 0x07,noise test config
