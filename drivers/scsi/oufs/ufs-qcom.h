...
#define REG_UFS_CFG2_CGC_EN_ALL                                                \
	(UAWM_HW_CGC_EN | UARM_HW_CGC_EN | TXUC_HW_CGC_EN | RXUC_HW_CGC_EN |   \
	 DFC_HW_CGC_EN | TRLUT_HW_CGC_EN | TMRLUT_HW_CGC_EN | OCSC_HW_CGC_EN)
...
#define UFS_HW_CLK_CTRL_EN                                                     \
	(CC_UFS_SYS_CLK_REQ_EN | CC_UFS_ICE_CORE_CLK_REQ_EN |                  \
	 CC_UFS_UNIPRO_CORE_CLK_REQ_EN | CC_UFS_AUXCLK_REQ_EN)
/* bit offset */
enum {
