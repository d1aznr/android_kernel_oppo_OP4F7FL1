...
ufshcd_blk_crypto_mode_num_for_alg_dusize(enum ufs_crypto_alg ufs_crypto_alg,
...
int ufshcd_prepare_lrbp_crypto_spec(struct ufs_hba *hba, struct scsi_cmnd *cmd,
...
int ufshcd_hba_init_crypto(struct ufs_hba *hba)
{
	if (hba->crypto_vops && hba->crypto_vops->hba_init_crypto)
		return hba->crypto_vops->hba_init_crypto(hba, &ufshcd_ksm_ops);
...
int ufshcd_prepare_lrbp_crypto(struct ufs_hba *hba, struct scsi_cmnd *cmd,
			       struct ufshcd_lrb *lrbp)
{
...
int ufshcd_complete_lrbp_crypto(struct ufs_hba *hba, struct scsi_cmnd *cmd,
				struct ufshcd_lrb *lrbp)
{
