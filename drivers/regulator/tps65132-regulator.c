...
int TPS65132_reg_init(void)
{
	...
	if (!pchip->regmap || !TPS65132_pchip->regmap ||
	    !TPS65132_pchip->pdata) {
			     ...
			     const struct i2c_device_id *id)
{
	...
	if (client->dev.of_node) {
		pdata = devm_kzalloc(&client->dev,
				     sizeof(struct tps65132_platform_data),
				     GFP_KERNEL);
		if (!pdata) {
...
static const struct i2c_device_id TPS65132_bl_ids[] = { { "ti,tps65132", 0 },
							{} };
