...
struct vooc_charge_strategy {
	...
	struct input_current_setting
		input_current[OPLUS_CHG_VOOC_INPUT_CURRENT_MAX_CNT];
};
...
struct vooc_charge_strategy *
	g_vooc_charge_strategy_p[OPLUS_FASTCHG_OUTPUT_POWER_MAX] = { NULL, NULL,
								     NULL, NULL,
								     NULL };
...
static struct oplus_chg_debug_notify_policy oplus_chg_debug_notify_policy[] = {
	[OPLUS_NOTIFY_BATT_SOC_CAPCITY_LOAD_JUMP] = { OPLUS_CHG_NOTIFY_ONCE, 1,
						      1, -1,
						      "Soc-LoadSocJump" },
	[OPLUS_NOTIFY_BATT_UI_SOC_CAPCITY_LOAD_JUMP] = { OPLUS_CHG_NOTIFY_ONCE,
							 1, 1, -1,
							 "UiSoc_LoadSocJump" },
	[OPLUS_NOTIFY_BATT_SOC_CAPCITY_JUMP] = { OPLUS_CHG_NOTIFY_REPEAT, 1, 1,
						 -1, "SocJump" },
	[OPLUS_NOTIFY_BATT_UI_SOC_CAPCITY_JUMP] = { OPLUS_CHG_NOTIFY_REPEAT, 1,
						    1, -1, "UiSocJump" },
	[OPLUS_NOTIFY_BATT_UI_TO_SOC_CAPCITY_JUMP] = { OPLUS_CHG_NOTIFY_REPEAT,
						       1, 1, -1,
						       "UiSoc-SocJump" },
	[OPLUS_NOTIFY_CHG_BATT_FULL_NON_100_CAP] = { OPLUS_CHG_NOTIFY_ONCE, 3,
						     3, -1,
						     "BattFull-SocNot100" },

	[OPLUS_NOTIFY_CHG_SLOW_BATT_WARM_TEMP] = { OPLUS_CHG_NOTIFY_ONCE, 1, 1,
						   -1, "BattTempWarm" },
	[OPLUS_NOTIFY_CHG_SLOW_BATT_COLD_TEMP] = { OPLUS_CHG_NOTIFY_ONCE, 1, 1,
						   -1, "BattTempCold" },
	[OPLUS_NOTIFY_CHG_SLOW_LOW_CHARGE_CURRENT_LONG_TIME] = { OPLUS_CHG_NOTIFY_TOTAL,
								 720, 1440, 70,
								 "SmallCurrentLongTime" },
	[OPLUS_NOTIFY_CHG_SLOW_CHG_TYPE_SDP] = { OPLUS_CHG_NOTIFY_ONCE, 1, 1,
						 -1, "SDP-CHG" },
	[OPLUS_NOTIFY_CHG_SLOW_VOOC_NON_START] = { OPLUS_CHG_NOTIFY_ONCE, 1, 1,
						   -1, "FastChgNotStart" },
	[OPLUS_NOTIFY_CHG_SLOW_VOOC_ADAPTER_NON_MAX_POWER] = { OPLUS_CHG_NOTIFY_ONCE,
							       1, 1, -1,
							       "AdatpterNotMaxPower" },
	[OPLUS_NOTIFY_CHG_SLOW_COOLDOWN_LONG_TIME] = { OPLUS_CHG_NOTIFY_TOTAL,
						       720, 1440, 70,
						       "CoolDownCtlLongTime" },
	[OPLUS_NOTIFY_CHG_SLOW_SYS_POWER_CONSUME_HIGH] = { OPLUS_CHG_NOTIFY_TOTAL,
							   720, 1440, 40,
							   "SysConsumeHigh" },
	[OPLUS_NOTIFY_CHG_SLOW_LED_ON_LONG_TIME] = { OPLUS_CHG_NOTIFY_TOTAL,
						     720, 1440, 70,
						     "LedOnLongTime" },

	[OPLUS_NOTIFY_CHG_SLOW_BATT_NON_AUTH] = { OPLUS_CHG_NOTIFY_ONCE, 1, 1,
						  -1, "BattNotAuth" },
	[OPLUS_NOTIFY_CHG_SLOW_CHARGER_OV] = { OPLUS_CHG_NOTIFY_REPEAT, 1, 1,
					       -1, "ChargerOV" },
	[OPLUS_NOTIFY_GAUGE_SEAL_FAIL] = { OPLUS_CHG_NOTIFY_REPEAT, 1, 1, -1,
					   "GaugeSealFail" },
	[OPLUS_NOTIFY_GAUGE_UNSEAL_FAIL] = { OPLUS_CHG_NOTIFY_REPEAT, 1, 1, -1,
					     "GaugeUnSealFail" },
	...
	[OPLUS_NOTIFY_VOOCPHY_ERR] = { OPLUS_CHG_NOTIFY_REPEAT, 1, 1, -1,
				       "VoocPhyErr" }, /*add for voocPhy chg*/
	[OPLUS_NOTIFY_MCU_UPDATE_FAIL] = { OPLUS_CHG_NOTIFY_REPEAT, 1, 1, -1,
					   "McuUpdateFail" },
	[OPLUS_NOTIFY_SC85x7_ERROR] = { OPLUS_CHG_NOTIFY_REPEAT, 1, 1, -1,
					"SC85x7Error" },

	[OPLUS_NOTIFY_BATT_AGING_CAP] = { OPLUS_CHG_NOTIFY_REPEAT, 1, 1, -1,
					  "BattAgeStat" },

	[OPLUS_NOTIFY_CHG_VOOC_BREAK] = { OPLUS_CHG_NOTIFY_ONCE, 1, 1, -1,
					  "FastChgBreak" },
	[OPLUS_NOTIFY_CHG_GENERAL_BREAK] = { OPLUS_CHG_NOTIFY_ONCE, 1, 1, -1,
					     "GeneralChgBreak" },
	[OPLUS_NOTIFY_CHARGER_INFO] = { OPLUS_CHG_NOTIFY_REPEAT, 1, 1, -1,
					"ChargerInfo" },
	[OPLUS_NOTIFY_FAST_CHARGER_TIME] = { OPLUS_CHG_NOTIFY_TOTAL, 720, 1440,
					     70, "FastChgTime-s" },
	[OPLUS_NOTIFY_MCU_ERROR_CODE] = { OPLUS_CHG_NOTIFY_REPEAT, 1, 1, -1,
					  "ErroFromMcu" },
	[OPLUS_NOTIFY_CHG_BATT_RECHG] = { OPLUS_CHG_NOTIFY_REPEAT, 1, 1, -1,
					  "ReChgCnt" }, /*add for ReChgCnt*/
	...
	[OPLUS_NOTIFY_WIRELESS_START_CHG] = { OPLUS_CHG_NOTIFY_REPEAT, 1, 1, -1,
					      "WirelessStartChg" },
	[OPLUS_NOTIFY_WIRELESS_WIRELESS_CHG_BREAK] = { OPLUS_CHG_NOTIFY_REPEAT,
						       1, 1, -1,
						       "WirelessChgBreak" },
	[OPLUS_NOTIFY_WIRELESS_WIRELESS_CHG_END] = { OPLUS_CHG_NOTIFY_REPEAT, 1,
						     1, -1,
						     "WirelessEndChg" }, /*add for wireless chg end*/
	[OPLUS_NOTIFY_WIRELESS_START_TX] = { OPLUS_CHG_NOTIFY_REPEAT, 1, 1,
					     -1 },
	[OPLUS_NOTIFY_WIRELESS_STOP_TX] = { OPLUS_CHG_NOTIFY_REPEAT, 1, 1, -1 },
	[OPLUS_NOTIFY_BCC_ANODE_POTENTIAL_OVER_TIME] = { OPLUS_CHG_NOTIFY_REPEAT,
							 1, 1, -1,
							 "BccAnodePotentialOverTime" },
	[OPLUS_NOTIFY_BCC_CURR_ADJUST_ERR] = { OPLUS_CHG_NOTIFY_REPEAT, 1, 1,
					       -1, "BccCurrAdjustErr" },
	[OPLUS_NOTIFY_PARALLEL_LIMITIC_ERROR] = { OPLUS_CHG_NOTIFY_ONCE, 1, 1,
						  -1, "Parallel_LimitIcError" },
	[OPLUS_NOTIFY_PARALLEL_FULL_NON_100_ERROR] = { OPLUS_CHG_NOTIFY_ONCE, 1,
						       1, -1,
						       "Parallel_FullNot100" },
	[OPLUS_NOTIFY_FG_CAN_NOT_UPDATE] = { OPLUS_CHG_NOTIFY_REPEAT, 1, 1, -1,
					     "FgCanNotUpdate" },
};
...
static struct oplus_chg_debug_type_policy oplus_chg_debug_type_policy[] = {
	...
	[OPLUS_CHG_DEBUG_NOTIFY_TYPE_WIRELESS] = { -1,
						   "Wireless" }, /*add for wireless chg*/
	[OPLUS_CHG_DEBUG_NOTIFY_TYPE_RECHG] = { -1,
						"ReChgCnt" }, /*add for ReChgCnt*/
	[OPLUS_CHG_DEBUG_NOTIFY_TYPE_SC85x7] = { -1,
						 "sc85x7_error" }, /*add for sc85x7*/
};
...
static int oplus_chg_pack_debug_info(struct oplus_chg_chip *chip)
{
	...
	if (len) {
		...
		memset(oplus_chg_debug_info.dcs_info, 0x0,
		       sizeof(struct kernel_packet_info));

		oplus_chg_debug_info.dcs_info->type = 1;
		memcpy(oplus_chg_debug_info.dcs_info->log_tag, log_tag,
		       strlen(log_tag));
		memcpy(oplus_chg_debug_info.dcs_info->event_id, event_id,
		       strlen(event_id));
...
static void oplus_chg_send_info_dwork(struct work_struct *work)
{
	...
	if ((ret > 0) && (oplus_chg_debug_info.retry_cnt > 0)) {
		queue_delayed_work(oplus_chg_debug_info.oplus_chg_debug_wq,
				   &oplus_chg_debug_info.send_info_dwork,
				   msecs_to_jiffies(SEND_INFO_DELAY));
	} else {
		//soc jump
		oplus_chg_debug_mask_notify_flag(
			0, OPLUS_NOTIFY_CHG_BATT_FULL_NON_100_CAP);
		...
		memset(oplus_chg_debug_info.flag_reason, 0,
		       sizeof(oplus_chg_debug_info.flag_reason));
		memset(oplus_chg_debug_info.type_reason, 0,
		       sizeof(oplus_chg_debug_info.type_reason));
		memset(oplus_chg_debug_info.bcc_buf, 0,
		       sizeof(oplus_chg_debug_info.bcc_buf));
...
static int oplus_chg_percent_cnt(int index)
{
	...
	pct = oplus_chg_debug_info.chg_cnt[index] * 5 * 100 /
	      oplus_chg_debug_info.total_time_count;
	if (pct > 100) {
		pct = 100;
	}
	return pct;
...
static void oplus_chg_print_debug_info(struct oplus_chg_chip *chip)
{
	...
	defined(CONFIG_OPLUS_FEATURE_FEEDBACK_MODULE)
		...
		ret += snprintf(&oplus_chg_debug_msg[ret],
				OPLUS_CHG_DEBUG_MSG_LEN - ret,
				OPLUS_CHG_DEBUG_EVENT_ID "$$");
#endif
		//add for common
		ret += snprintf(&oplus_chg_debug_msg[ret],
				OPLUS_CHG_DEBUG_MSG_LEN - ret, "type@@0x%x",
				oplus_chg_debug_info.notify_type);

		ret += snprintf(&oplus_chg_debug_msg[ret],
				OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$flag@@0x%llx",
		...
		ret += snprintf(&oplus_chg_debug_msg[ret],
				OPLUS_CHG_DEBUG_MSG_LEN - ret,
				"$$adapter_type@@0x%x",
				(oplus_chg_debug_info.fast_chg_type << 8) |
					oplus_chg_debug_info.real_charger_type);
		if (oplus_chg_get_vooc_adapter_name_index(chip) >= 0) {
			ret += snprintf(
				&oplus_chg_debug_msg[ret],
				OPLUS_CHG_DEBUG_MSG_LEN - ret,
				"$$vooc_adapter_name@@%s",
				vooc_adapter_name
					[oplus_chg_get_vooc_adapter_name_index(
						chip)]);
		}
		...
		ret += snprintf(&oplus_chg_debug_msg[ret],
				OPLUS_CHG_DEBUG_MSG_LEN - ret,
				"$$norm_adapter_name@@%s",
				norm_adapter_name[oplus_chg_debug_info
							  .real_charger_type]);

		ret += snprintf(&oplus_chg_debug_msg[ret],
				OPLUS_CHG_DEBUG_MSG_LEN - ret,
				"$$rechg_counts@@%d",
				oplus_chg_debug_info
					.rechg_counts); /*add for rechg counts*/
		...
		ret += snprintf(
			&oplus_chg_debug_msg[ret],
			OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$led_on_percent@@%d",
			oplus_chg_percent_cnt(
				OPLUS_NOTIFY_CHG_SLOW_LED_ON_LONG_TIME));
		...
		ret += snprintf(&oplus_chg_debug_msg[ret],
				OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$batt_fcc@@%d",
				chip->batt_fcc);
		...
		ret += snprintf(&oplus_chg_debug_msg[ret],
				OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$vbat@@%d",
				chip->batt_volt);
		ret += snprintf(&oplus_chg_debug_msg[ret],
				OPLUS_CHG_DEBUG_MSG_LEN - ret,
		...
		//add for soc jump
		if (oplus_chg_debug_notify_type_is_set(
		...
		if (oplus_chg_debug_info.vooc_mcu_error != 0)
			ret += snprintf(&oplus_chg_debug_msg[ret],
					OPLUS_CHG_DEBUG_MSG_LEN - ret,
					"$$vooc_mcu_error@@0x%x",
					oplus_chg_debug_info.vooc_mcu_error);
		...
		if (oplus_chg_chg_is_normal_path(chip)) {
			...
			ret += snprintf(
				&oplus_chg_debug_msg[ret],
				OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$ibus@@%d",
				oplus_chg_debug_info.fastchg_input_current);
		}

		/*add for wireless chg*/
		if ((oplus_chg_debug_info.notify_type &
		     (1 << OPLUS_CHG_DEBUG_NOTIFY_TYPE_WIRELESS))) {
			ret += snprintf(
				&oplus_chg_debug_msg[ret],
				OPLUS_CHG_DEBUG_MSG_LEN - ret,
				"$$tx_version@@0x%x",
			...
			ret += snprintf(
				...
				OPLUS_CHG_DEBUG_MSG_LEN - ret,
				"$$adapter_type_wpc@@%d",
				oplus_chg_debug_info.wireless_info.adapter_type);
			ret += snprintf(&oplus_chg_debug_msg[ret],
					OPLUS_CHG_DEBUG_MSG_LEN - ret,
					"$$work_silent_mode@@%d",
					oplus_chg_debug_info.wireless_info
						.work_silent_mode);
		}
		...
		ret += snprintf(
			...
			tm.tm_hour, tm.tm_min, tm.tm_sec, chip->charger_exist,
			chip->charger_type, chip->charger_volt,
			chip->prop_status, chip->boot_mode,
			oplus_chg_debug_info.chg_current_by_tbatt,
			oplus_chg_debug_info.chg_current_by_cooldown,
			chip->batt_exist, chip->batt_full, chip->chging_on,
			chip->in_rechging, chip->charging_state,
			oplus_chg_debug_info.total_time, chip->temperature,
		...
		if (oplus_switching_support_parallel_chg()) {
			ret += snprintf(
				...
				oplus_switching_get_charge_enable(),
				oplus_switching_get_fastcharge_current(),
				oplus_switching_get_discharge_current());
		}

		if (oplus_chg_debug_info.fg_error_flag != 0 &&
		    oplus_chg_debug_info.fg_info) {
			ret += snprintf(&oplus_chg_debug_msg[ret],
					OPLUS_CHG_DEBUG_MSG_LEN - ret,
					"FG_CAN_NOT_UPDATE[%d] %s",
		...
		if (vooc_chip) {
			ret += snprintf(&oplus_chg_debug_msg[ret],
					OPLUS_CHG_DEBUG_MSG_LEN - ret,
					"VOOC[ %d / %d / %d / %d / %d / %d]",
					vooc_chip->fastchg_allow,
					vooc_chip->fastchg_started,
					vooc_chip->fastchg_dummy_started,
					vooc_chip->fastchg_to_normal,
					vooc_chip->fastchg_to_warm,
		...
		if (oplus_chg_debug_info.wirelesspen_info.support) {
			ret += snprintf(&oplus_chg_debug_msg[ret],
					...
					oplus_chg_debug_info.wirelesspen_info
						.ble_timeout_cnt,
					oplus_chg_debug_info.wirelesspen_info
						.verify_failed_cnt);
		...
		if (voocphy_chip) {
			ret += snprintf(
				...
				"[%d, %d, %d, %d],"
				"[%d, %d, %d, %d], ",
				voocphy_chip->ap_disconn_issue,
				voocphy_chip->disconn_pre_ibat,
				voocphy_chip->disconn_pre_ibus,
				voocphy_chip->disconn_pre_vbat,
				voocphy_chip->disconn_pre_vbat_calc,
				voocphy_chip->disconn_pre_vbus,
				voocphy_chip->r_state,
				voocphy_chip->vbus_adjust_cnt,
				voocphy_chip->voocphy_cp_irq_flag,
				voocphy_chip->voocphy_enable,
				voocphy_chip->slave_voocphy_enable,
				voocphy_chip->voocphy_iic_err,
				voocphy_chip->slave_voocphy_iic_err,
				voocphy_chip->voocphy_vooc_irq_flag,
				voocphy_chip->irq_rcvok_num,
				voocphy_chip->ap_handle_timeout_num,
				voocphy_chip->rcv_date_err_num,
				voocphy_chip->rcv_done_200ms_timeout_num,
				voocphy_chip->max_div_cp_ichg,
				voocphy_chip->vbat_deviation_check);
			...
			if (oplus_chg_debug_info.sc85x7_error_reason[0] > 0) {
				ret += snprintf(&oplus_chg_debug_msg[ret],
						...
						oplus_chg_debug_info
							.sc85x7_error_reason);
				rtc_time_to_tm(oplus_chg_debug_info
						       .charge_start_ts.tv_sec,
					       &tm);
				ret += snprintf(&oplus_chg_debug_msg[ret],
						OPLUS_CHG_DEBUG_MSG_LEN - ret,
						"time[%d-%d-%d %d:%d:%d], ",
				...
				ret += snprintf(
					...
					OPLUS_CHG_DEBUG_MSG_LEN - ret,
					"%d, %d, %d, %d, %d]",
					voocphy_chip->master_cp_ichg,
					voocphy_chip->slave_cp_ichg,
					voocphy_chip->master_error_ibus,
					voocphy_chip->slave_error_ibus,
		...
		if (chg_check_point_debug & OPEN_LOG_BIT) {
			...
			for (i = 0; i < OPLUS_NOTIFY_CHG_MAX_CNT; i++) {
				ret += snprintf(
					&oplus_chg_debug_msg[ret],
					OPLUS_CHG_DEBUG_MSG_LEN - ret, "%4d ",
		...
		ret += snprintf(&oplus_chg_debug_msg[ret],
				OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$Ver_Os@@%s",
				"2.0_12.0");

		if (oplus_chg_debug_info.notify_type &
		    (1 << OPLUS_CHG_DEBUG_NOTIFY_TYPE_BCC_ERR)) {
			ret += snprintf(&oplus_chg_debug_msg[ret],
					OPLUS_CHG_DEBUG_MSG_LEN - ret, "%s",
	...
	defined(CONFIG_OPLUS_FEATURE_FEEDBACK_MODULE)
		...
		if (oplus_chg_debug_info.notify_type ||
		    oplus_chg_debug_notify_flag_is_set(
...
#endif
		oplus_chg_debug_info.real_charger_type =
			oplus_chg_get_real_charger_type(chip);
	}
}
...
{
	int i;
	int arr_size = sizeof(vooc_charger_type_list) /
		       sizeof(vooc_charger_type_list[0]);

	for (i = 0; i < arr_size; i++) {
		if (oplus_chg_debug_info.fast_chg_type ==
		    vooc_charger_type_list[i].chg_type) {
			break;
		}
	}
...
static int
oplus_chg_get_vooc_adapter_is_low_input_power(struct oplus_chg_chip *chip)
{
	...
	adapter_input_power =
		vooc_charger_type_list[vooc_adapter_type_index].vol *
		vooc_charger_type_list[vooc_adapter_type_index].cur;

	if (adapter_input_power < (oplus_chg_debug_info.vooc_max_input_volt *
...
static int oplus_chg_get_vooc_chg_max_input_power(struct oplus_chg_chip *chip)
{
	...
	return (oplus_chg_debug_info.vooc_max_input_volt *
		oplus_chg_debug_info.vooc_max_input_current * 8 / 10);
}
...
static int oplus_chg_get_vooc_input_power(struct oplus_chg_chip *chip)
{
	...
	vol = oplus_chg_debug_info.vooc_max_input_volt <
			      vooc_charger_type_list[i].vol ?
		      oplus_chg_debug_info.vooc_max_input_volt :
		      vooc_charger_type_list[i].vol;
	cur = oplus_chg_debug_info.vooc_max_input_current <
	...
	if (vooc_chip != NULL) {
		if (vooc_chip->vooc_chg_current_now > 0) {
			cur = cur < vooc_chip->vooc_chg_current_now ?
				      cur :
				      vooc_chip->vooc_chg_current_now;
		}
		...
		if (ret > 0 && ret < (array_len + 1)) {
			cur = cur < multistepCurrent_debug[ret - 1] ?
				      cur :
				      multistepCurrent_debug[ret - 1];
		}
	}
	...
	if (oplus_chg_debug_info.vooc_charge_strategy) {
		...
		mcu_chg_current =
			oplus_chg_debug_info.vooc_charge_strategy
				->input_current
					[oplus_chg_debug_info
						 .vooc_charge_input_current_index]
				.cur;
...
static int oplus_chg_set_chg_flag(int index)
{
	...
	if ((oplus_chg_debug_info.fast_chg_type ==
		...
		policy_time =
			oplus_chg_debug_notify_policy[index].normal_chg_time;
	} else {
		policy_time =
			oplus_chg_debug_notify_policy[index].fast_chg_time;
	}
	...
	case OPLUS_CHG_NOTIFY_TOTAL:
		if (((oplus_chg_debug_info.chg_cnt[index] %
		      (policy_time *
		       oplus_chg_debug_notify_policy[index].percent / 100)) ==
		     0)) {
			oplus_chg_debug_info.notify_flag |= (1L << index);
		}
		rc = 0;
...
static int oplus_chg_vooc_charge_strategy_init(struct oplus_chg_chip *chip)
{
	...
	if (oplus_chg_debug_info.vooc_charge_strategy != NULL) {
		for (i = oplus_chg_debug_info.vooc_charge_input_current_index;
		     i < OPLUS_CHG_VOOC_INPUT_CURRENT_MAX_CNT; i++) {
			if (chip->batt_volt <=
			    oplus_chg_debug_info.vooc_charge_strategy
				    ->input_current[i]
				    .vol) {
				if (i ==
				    oplus_chg_debug_info
					    .vooc_charge_input_current_index)
					oplus_chg_debug_info
						.vooc_charge_cur_state_chg_time +=
						5;

				if (oplus_chg_debug_info.vooc_charge_strategy
					    ->input_current[i]
					    .time > 0) {
					if (oplus_chg_debug_info
						    .vooc_charge_cur_state_chg_time >=
					    oplus_chg_debug_info
						    ...
						    .time) {
						if (i <
						    (OPLUS_CHG_VOOC_INPUT_CURRENT_MAX_CNT -
						     1)) {
							i++;
						}
					}
	...
	if (!oplus_chg_chg_is_normal_path(chip)) {
		if (oplus_vooc_get_fastchg_started()) {
			index = oplus_chg_get_vooc_adapter_type_index(chip);
			output_power_type =
				vooc_charger_type_list[index].output_power_type;
		}
	}
	...
	if (output_power_type >= 0) {
		...
		vooc_charge_strategy_p =
			g_vooc_charge_strategy_p[output_power_type];

		if (vooc_charge_strategy_p) {
			for (i = 0;
			     vooc_charge_strategy_p[i].capacity_range.low != -1;
			     i++) {
				if ((vooc_charge_strategy_p[i]
					     .capacity_range.low < start_soc) &&
				    (vooc_charge_strategy_p[i]
					     .capacity_range.high >=
				     start_soc) &&
		...
		for (i = oplus_chg_debug_info.vooc_charge_input_current_index;
			...
			if (chip->batt_volt <=
			    oplus_chg_debug_info.vooc_charge_strategy
				    ...
				    .vol) {
				oplus_chg_debug_info
					.vooc_charge_input_current_index = i;
				oplus_chg_debug_info
					.vooc_charge_cur_state_chg_time = 5;
				break;
			}
		}
	}
...
int oplus_chg_debug_get_cooldown_current(int chg_current_by_tbatt,
...
static int oplus_chg_normal_chg_consume_power_check(struct oplus_chg_chip *chip)
{
	...
	if (!chip->led_on) {
		if ((chip->total_time -
		     oplus_chg_debug_info.led_off_start_time) >
		    LED_OFF_STABLE_TIME) {
			if ((input_power + charge_power) >
			    LED_OFF_HIGH_POWER_CONSUPTION) {
				oplus_chg_set_chg_flag(
					OPLUS_NOTIFY_CHG_SLOW_SYS_POWER_CONSUME_HIGH);
			}
		}
	} else {
		if ((input_power + charge_power) >
		    LED_ON_HIGH_POWER_CONSUPTION) {
			oplus_chg_set_chg_flag(
				OPLUS_NOTIFY_CHG_SLOW_SYS_POWER_CONSUME_HIGH);
		}
	}
...
static int oplus_parallel_full_soc_error_check(struct oplus_chg_chip *chip)
{
	...
	if ((chg_status == POWER_SUPPLY_STATUS_FULL) &&
	    (chip->sub_batt_soc < 97 || chip->soc < 97)) {
		if (!oplus_chg_debug_notify_type_is_set(
			    OPLUS_CHG_DEBUG_NOTIFY_TYPE_GAUGE_ERROR)) {
			oplus_chg_set_notify_type(
				OPLUS_CHG_DEBUG_NOTIFY_TYPE_GAUGE_ERROR);
			if (!oplus_chg_debug_notify_flag_is_set(
				    OPLUS_NOTIFY_PARALLEL_FULL_NON_100_ERROR)) {
				oplus_chg_set_chg_flag(
					OPLUS_NOTIFY_PARALLEL_FULL_NON_100_ERROR);
...
static int oplus_parallel_limitic_error_check(struct oplus_chg_chip *chip)
{
	...
	if ((oplus_switching_get_charge_enable() == true) &&
	    (chip->sub_batt_icharging < 0 && chip->icharging < 0) &&
...
static int oplus_chg_break_check(struct oplus_chg_chip *chip)
{
	...
	if (chip->detect_detach_unexpeactly == 1 ||
		...
		strcpy(oplus_chg_debug_info.flag_reason,
		       oplus_chg_debug_notify_policy[OPLUS_NOTIFY_CHG_VOOC_BREAK]
			       .reason);
	} else if (chip->detect_detach_unexpeactly == 2 ||
		   (break_flag == 2 &&
		    (chg_check_point_debug & OPEN_LOG_BIT))) {
...
void oplus_chg_fg_can_not_update(char *fg_erro_info)
{
	...
	if (!oplus_chg_debug_notify_type_is_set(
		...
		oplus_chg_set_notify_type(
			OPLUS_CHG_DEBUG_NOTIFY_TYPE_GAUGE_ERROR);
		if (!oplus_chg_debug_notify_type_is_set(
			    OPLUS_NOTIFY_FG_CAN_NOT_UPDATE)) {
			oplus_chg_set_notify_type(
				OPLUS_NOTIFY_FG_CAN_NOT_UPDATE);
			oplus_chg_debug_info.fg_error_count++;
...
static int oplus_chg_input_power_limit_check(struct oplus_chg_chip *chip)
{
	...
	if (vooc_chip) {
		if (chip->charger_type == POWER_SUPPLY_TYPE_USB_DCP) {
			if ((chip->soc < vooc_chip->vooc_high_soc) &&
			    (chip->soc > vooc_chip->vooc_low_soc)) {
				if (chip->temperature >=
				    vooc_chip->vooc_high_temp) {
					oplus_chg_set_chg_flag(
						OPLUS_NOTIFY_CHG_SLOW_BATT_WARM_TEMP);
				}

				if (chip->temperature <=
				    vooc_chip->vooc_low_temp) {
					oplus_chg_set_chg_flag(
						OPLUS_NOTIFY_CHG_SLOW_BATT_COLD_TEMP);
				}
			}
	...
	if (oplus_chg_chg_is_normal_path(chip)) {
		...
		if (chip->batt_volt < float_voltage) {
			...
			if ((default_input_current > 0) &&
			    (max_charger_voltage > 0)) {
				if ((-1 * charge_power * 10) <
				    (default_input_current *
				     max_charger_voltage / 1000)) {
					oplus_chg_set_chg_flag(
						OPLUS_NOTIFY_CHG_SLOW_LOW_CHARGE_CURRENT_LONG_TIME);
				}
			}
	...
	if (soc_start < soc_high_speed) { //start < 51
		if (soc_end < soc_high_speed) { //start<51 end<51
			...
			time_ref = speed_high * (soc_high_speed - soc_start) +
				   speed_mid * (soc_end - soc_start);
		} else if (soc_end < soc_low_speed) { //start<51 end<91
			time_ref =
				speed_high * (soc_high_speed - soc_start) +
				speed_mid * (soc_mid_speed - soc_high_speed) +
				speed_low * (soc_end - soc_start);
		} else if (soc_end < soc_loweset_speed) { //start<51 end<101
			time_ref =
				speed_high * (soc_high_speed - soc_start) +
				speed_mid * (soc_mid_speed - soc_high_speed) +
				speed_low * (soc_low_speed - soc_mid_speed) +
				speed_lowest * (soc_end - soc_start);
		}
		...
		if (soc_end < soc_low_speed) {
			...
			time_ref = speed_low * (soc_low_speed - soc_start) +
				   speed_lowest * (soc_end - soc_start);
		}
...
static int oplus_get_chg_slow_reason(struct oplus_chg_chip *chip)
{
	...
	if (oplus_chg_debug_notify_flag_is_set(
		    OPLUS_NOTIFY_CHG_SLOW_BATT_WARM_TEMP) == 1) {
	...
	if (oplus_chg_debug_notify_flag_is_set(
		    OPLUS_NOTIFY_CHG_SLOW_BATT_COLD_TEMP) == 1) {
		oplus_chg_set_notify_type(OPLUS_CHG_DEBUG_NOTIFY_TYPE_CHG_SLOW);
		strcpy(oplus_chg_debug_info.flag_reason,
		       oplus_chg_debug_notify_policy
			       [OPLUS_NOTIFY_CHG_SLOW_BATT_COLD_TEMP]
	...
	if (oplus_chg_debug_info.cur_ui_soc <=
	    oplus_chg_debug_info.chg_start_ui_soc) {
		time = time_ref + 1;
	} else {
	...
	for (i = OPLUS_NOTIFY_CHG_SLOW_BATT_WARM_TEMP;
	     i <= OPLUS_NOTIFY_CHG_SLOW_LED_ON_LONG_TIME; i++) {
		if (oplus_chg_debug_notify_policy[i].policy ==
		    OPLUS_CHG_NOTIFY_ONCE) {
		...
		if (oplus_chg_debug_notify_policy[i].policy ==
		    OPLUS_CHG_NOTIFY_TOTAL) {
			if (oplus_chg_debug_info.chg_cnt[i] * 5 * 100 /
				    oplus_chg_debug_info.total_time_count >
...
static int oplus_chg_chg_slow_check(struct oplus_chg_chip *chip)
{
	...
	if (chip->charger_exist &&
		...
		if ((chip->tbatt_status == BATTERY_STATUS__WARM_TEMP) ||
			...
			oplus_chg_set_chg_flag(
				OPLUS_NOTIFY_CHG_SLOW_BATT_WARM_TEMP); //batt temp high slow chg
		}
		if ((chip->tbatt_status == BATTERY_STATUS__COLD_TEMP) ||
			...
			oplus_chg_set_chg_flag(
				OPLUS_NOTIFY_CHG_SLOW_BATT_COLD_TEMP); //batt temp low slow chg
		}
	}
	...
	if ((oplus_chg_debug_info.pre_prop_status != chip->prop_status) &&
		...
		if (!chip->charger_exist) {
			if (stop_chg_flag) { //plug after stop
				...
				if (oplus_chg_debug_info.total_time_count >
				    OPLUS_CHG_FEEDBACK_TIME) {
					oplus_chg_set_chg_flag(
						OPLUS_NOTIFY_CHARGER_INFO);
	...
	if (chip->charger_exist) {
		if (!oplus_chg_debug_info.total_time) {
			...
			getnstimeofday(&ts);
			oplus_chg_debug_info.total_time =
				5 + ts.tv_sec -
				oplus_chg_debug_info.charge_start_ts.tv_sec;
		}
	} else {
		if ((oplus_chg_debug_notify_flag_is_set(
			     OPLUS_NOTIFY_CHG_SLOW_BATT_WARM_TEMP) == 1 ||
		     oplus_chg_debug_notify_flag_is_set(
			     OPLUS_NOTIFY_CHG_SLOW_BATT_COLD_TEMP) == 1) &&
		    stop_chg_flag ==
			    false) { //tbatt is warm or cold before charge start
			oplus_chg_stop_action(chip);
			oplus_chg_debug_info_reset();
			return 0;
		}
	...
	oplus_chg_debug_info.real_charger_type =
		oplus_chg_get_real_charger_type(chip);
	if ((oplus_chg_debug_info.pre_prop_status != chip->prop_status) &&
	    (oplus_chg_debug_info.pre_prop_status !=
	...
	} else if (chip->vooc_project &&
		   (oplus_vooc_get_fastchg_started() == false) &&
		   oplus_chg_debug_info.chg_cnt[OPLUS_NOTIFY_FAST_CHARGER_TIME] <
			   3 &&
		   chip->total_time > 30) {
...
static int oplus_chg_chg_batt_aging_check(struct oplus_chg_chip *chip)
{
	...
	if ((aging_cap_test > 0) ||
	    ((count++ > OPLUS_CHG_BATT_AGING_CHECK_CNT) &&
	     (chg_check_point_debug & OPEN_LOG_BIT))) {
		getnstimeofday(&ts);
		...
		if (((aging_cap_test > 0) &&
		    ...
		    (ts.tv_sec - last_ts.tv_sec >
		     OPLUS_CHG_BATT_AGING_CHECK_TIME)) {
...
static void oplus_chg_soc_load_dwork(struct work_struct *work)
{
	if (oplus_chg_debug_info.soc_load_flag &
	    (1 << OPLUS_NOTIFY_BATT_SOC_CAPCITY_LOAD_JUMP)) {
	...
	if (oplus_chg_debug_info.soc_load_flag &
	    (1 << OPLUS_NOTIFY_BATT_UI_SOC_CAPCITY_LOAD_JUMP)) {
		oplus_chg_set_chg_flag(
...
static int oplus_chg_chg_batt_capacity_jump_check(struct oplus_chg_chip *chip)
{
	...
	if (oplus_chg_debug_info.cur_soc == OPLUS_CHG_BATT_INVALID_CAPACITY) {
		...
		if (abs(oplus_chg_debug_info.cur_soc - chip->soc_load) >
		    OPLUS_CHG_BATT_S0C_CAPACITY_LOAD_JUMP_NUM) {
			oplus_chg_debug_info.soc_load_flag |=
				1 << OPLUS_NOTIFY_BATT_SOC_CAPCITY_LOAD_JUMP;
		}

		if (abs(oplus_chg_debug_info.cur_ui_soc - chip->soc_load) >
		    OPLUS_CHG_BATT_UI_S0C_CAPACITY_LOAD_JUMP_NUM) {
			oplus_chg_debug_info.soc_load_flag |=
				1 << OPLUS_NOTIFY_BATT_UI_SOC_CAPCITY_LOAD_JUMP;
		}
		...
		if (oplus_chg_debug_info.soc_load_flag) {
			...
			queue_delayed_work(
				oplus_chg_debug_info.oplus_chg_debug_wq,
				&oplus_chg_debug_info.soc_load_dwork,
				msecs_to_jiffies(SOC_LOAD_DELAY));
		}
	} else {
		...
		if ((abs(oplus_chg_debug_info.cur_soc -
			 oplus_chg_debug_info.pre_soc) >
		     OPLUS_CHG_BATT_S0C_CAPACITY_JUMP_NUM) &&
		    (!oplus_chg_soc_notified_flag_is_set(
			...
			if (oplus_chg_debug_info.cur_soc ==
			    oplus_chg_debug_info.pre_soc) {
				oplus_chg_unset_soc_notified_flag(
					OPLUS_NOTIFY_BATT_SOC_CAPCITY_JUMP);
			}
			if ((abs(oplus_chg_debug_info.cur_ui_soc -
				 oplus_chg_debug_info.pre_ui_soc) >
			     OPLUS_CHG_BATT_UI_S0C_CAPACITY_JUMP_NUM) &&
			    (!oplus_chg_soc_notified_flag_is_set(
				...
				if ((abs(oplus_chg_debug_info.cur_ui_soc -
					 oplus_chg_debug_info.cur_soc) >
				     OPLUS_CHG_BATT_UI_TO_S0C_CAPACITY_JUMP_NUM) &&
				    (!oplus_chg_soc_notified_flag_is_set(
...
static int oplus_chg_mcu_update_check(struct oplus_chg_chip *chip)
{
	...
	if ((charger_abnormal_log == CRITICAL_LOG_VOOC_FW_UPDATE_ERR &&
	     flag == false) ||
...
void oplus_chg_wireless_udpate_param(void)
{
	...
	if (wpc_chip) {
		...
		oplus_chg_debug_info.wireless_info.tx_version =
			wpc_chip->wpc_chg_data->tx_version;
		oplus_chg_debug_info.wireless_info.rx_version =
			wpc_chip->wpc_chg_data->rx_version;
		oplus_chg_debug_info.wireless_info.boot_version =
			wpc_chip->wpc_chg_data->boot_version;
		oplus_chg_debug_info.wireless_info.dock_version =
			wpc_chip->wpc_chg_data->dock_version;
		oplus_chg_debug_info.wireless_info.vout =
			wpc_chip->wpc_chg_data->vout;
		oplus_chg_debug_info.wireless_info.iout =
			wpc_chip->wpc_chg_data->iout;
		oplus_chg_debug_info.wireless_info.rx_temperature =
			wpc_chip->wpc_chg_data->rx_temperature;
		oplus_chg_debug_info.wireless_info.work_silent_mode =
			wpc_chip->wpc_chg_data->work_silent_mode;
		oplus_chg_debug_info.wireless_info.break_count =
			wpc_chip->wpc_chg_data->break_count;
		oplus_chg_debug_info.wireless_info.wpc_chg_err =
			wpc_chip->wpc_chg_data->wpc_chg_err;
		oplus_chg_debug_info.wireless_info.highest_temp =
			wpc_chip->wpc_chg_data->highest_temp;
		oplus_chg_debug_info.wireless_info.max_iout =
			wpc_chip->wpc_chg_data->max_iout;
		oplus_chg_debug_info.wireless_info.min_cool_down =
			wpc_chip->wpc_chg_data->min_cool_down;
		oplus_chg_debug_info.wireless_info.min_skewing_current =
			wpc_chip->wpc_chg_data->min_skewing_current;
		oplus_chg_debug_info.wireless_info.wls_auth_fail =
			wpc_chip->wpc_chg_data->wls_auth_fail;
#endif
		oplus_chg_debug_info.wireless_info.adapter_type =
			wpc_chip->wpc_chg_data->adapter_type;
		oplus_chg_debug_info.wireless_info.fastchg_ing =
			wpc_chip->wpc_chg_data->fastchg_ing;
		oplus_chg_debug_info.wireless_info.wpc_dischg_status =
			wpc_chip->wpc_chg_data->wpc_dischg_status;
	}
	return;
}

/*add for wireless chg*/
void oplus_chg_wireless_error(int error,
			      struct wireless_chg_debug_info *wireless_param)
{
	struct oplus_chg_chip *chip = g_debug_oplus_chip;
	if (!chip)
		return;
	if (error < OPLUS_NOTIFY_WIRELESS_BOOTUP ||
	    error > OPLUS_NOTIFY_WIRELESS_STOP_TX)
		return;

	if (!wireless_param) {
		oplus_chg_wireless_udpate_param();
	} else {
		memset(&oplus_chg_debug_info.wireless_info, 0x0,
		       sizeof(struct wireless_chg_debug_info));
		memcpy(&oplus_chg_debug_info.wireless_info, wireless_param,
		       sizeof(struct wireless_chg_debug_info));
	}
	...
	if (strlen(buf)) {
		if (!strncmp(buf, "1", 1)) {
			if (!oplus_chg_debug_notify_flag_is_set(
				...
				oplus_chg_set_chg_flag(
					OPLUS_NOTIFY_BCC_CURR_ADJUST_ERR);
				if (strlen(buf + BCC_LENGTH_DELETE) <
				    BCC_LINE_LENGTH_MAX)
					strncpy(oplus_chg_debug_info.bcc_buf,
						buf + BCC_LENGTH_DELETE,
						strlen(buf +
						       BCC_LENGTH_DELETE));
				else
					strncpy(oplus_chg_debug_info.bcc_buf,
...
static int oplus_chg_debug_info_parse_dt(struct oplus_chg_chip *chip)
{
	...
	int size;
	u32 val[2];
	char *vooc_adpater_name[] = { "vooc_charge_strategy_20w",
	...
	ret = of_property_read_u32(vooc_node,
				   "qcom,vooc-max-input-volt-support",
				   &oplus_chg_debug_info.vooc_max_input_volt);
	if (ret) {
	...
	for (i = 0; i < OPLUS_FASTCHG_OUTPUT_POWER_MAX; i++) {
		...
		g_vooc_charge_strategy_p[i] = kzalloc(
			(count + 1) * sizeof(struct vooc_charge_strategy),
			GFP_KERNEL);

		j = 0;
		for_each_child_of_node (node, child) {
			ret = of_property_read_u32_array(
				child, "capacity_range", val, 2);
			if (!ret) {
				g_vooc_charge_strategy_p[i][j]
					.capacity_range.low = val[0];
				g_vooc_charge_strategy_p[i][j]
					.capacity_range.high = val[1];
			}

			ret = of_property_read_u32_array(child, "temp_range",
							 val, 2);
			if (!ret) {
				g_vooc_charge_strategy_p[i][j].temp_range.low =
					val[0];
				g_vooc_charge_strategy_p[i][j].temp_range.high =
					val[1];
			}

			size = of_property_count_elems_of_size(
				child, "input_current", sizeof(u32));
			if (size >= 0) {
				for (k = 0;
				     (k < (size / 3)) &&
				     (k < OPLUS_CHG_VOOC_INPUT_CURRENT_MAX_CNT);
				     k++) {
					ret = of_property_read_u32_index(
						child, "input_current", 3 * k,
						&val[0]);
					if (!ret) {
						g_vooc_charge_strategy_p[i][j]
							.input_current[k]
...
static ssize_t charge_monitor_test_read(struct file *filp, char __user *buff,
...
int oplus_chg_debug_info_init(struct oplus_chg_chip *chip)
{
	...
	oplus_chg_debug_info.oplus_chg_debug_wq =
		create_workqueue("oplus_chg_debug_wq");
#if defined(CONFIG_OPLUS_FEATURE_FEEDBACK) ||                                  \
	defined(CONFIG_OPLUS_FEATURE_FEEDBACK_MODULE)
	oplus_chg_debug_info.dcs_info =
		(struct kernel_packet_info *)&oplus_chg_debug_msg[0];
	INIT_DELAYED_WORK(&oplus_chg_debug_info.send_info_dwork,
			  oplus_chg_send_info_dwork);
	mutex_init(&oplus_chg_debug_info.dcs_info_lock);
#endif
	INIT_DELAYED_WORK(&oplus_chg_debug_info.soc_load_dwork,
			  oplus_chg_soc_load_dwork);
