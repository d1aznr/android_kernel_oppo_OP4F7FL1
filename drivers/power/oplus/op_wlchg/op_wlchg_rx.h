...
struct rx_chip_prop {
	void *private_data;
	int (*get_prop)(struct rx_chip_prop *, enum rx_prop_type,
			union rx_chip_propval *);
	int (*set_prop)(struct rx_chip_prop *, enum rx_prop_type,
			union rx_chip_propval *);
...
int wlchg_rx_register_prop(struct device *parent,
			   struct rx_chip_prop *chip_prop);
