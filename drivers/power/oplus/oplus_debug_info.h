...
extern int oplus_chg_debug_get_cooldown_current(int chg_current_by_tbatt,
						int chg_current_by_cooldown);
...
extern void oplus_chg_wireless_error(
	int error,
	struct wireless_chg_debug_info *wireless_param); /*add for wireless chg*/
extern int oplus_chg_unsuspend_plat_pmic(
	struct oplus_chg_chip *chip); /*add for unsuspend platPmic*/
