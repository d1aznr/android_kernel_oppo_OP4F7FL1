...
void sc8571_master_cfg_sc(void)
{
	...
	sc8571_write_byte(SC8571_REG_0E,
...
{
	sc8571_write_byte(SC8571_REG_0F,
...
void sc8571_master_hardware_init(void)
{
	...
	sc8571_write_byte(SC8571_REG_24,
			  0x0E); /*0X24 disalbe TSBUT_ADC/TSBAT_ADC/IBAT_ADC*/
	pps_err(" end!\n");
}
