...
int oplus_chg_wls_rx_get_trx_curr(struct oplus_wls_chg_rx *wls_rx,
				  int *curr_ma);
...
int oplus_chg_wls_rx_set_rx_mode(struct oplus_wls_chg_rx *wls_rx,
				 enum oplus_chg_wls_rx_mode rx_mode);
...
int oplus_chg_wls_rx_get_trx_status(struct oplus_wls_chg_rx *wls_rx,
				    u8 *status);
...
int oplus_chg_wls_rx_get_rx_version(struct oplus_wls_chg_rx *wls_rx,
				    u32 *version);
int oplus_chg_wls_rx_get_trx_version(struct oplus_wls_chg_rx *wls_rx,
				     u32 *version);
...
int oplus_chg_wls_nor_set_rechg_vol(struct oplus_wls_chg_normal *wls_nor,
				    int rechg_vol_mv);
int oplus_chg_wls_nor_get_icl(struct oplus_wls_chg_normal *wls_nor,
			      int *icl_ma);
...
int oplus_chg_wls_nor_set_vindpm(struct oplus_wls_chg_normal *wls_nor,
				 int vindpm_mv);
...
int oplus_chg_wls_fast_get_fault(struct oplus_wls_chg_fast *wls_fast,
				 char *fault);
