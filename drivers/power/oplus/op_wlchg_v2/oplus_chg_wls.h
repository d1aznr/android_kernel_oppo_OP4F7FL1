...
#define FAN_PWM_PULSE_IN_FASTCHG_MODE_V03_07                                   \
	FAN_PWM_PULSE_IN_FASTCHG_MODE_DEFAULT
#define FAN_PWM_PULSE_IN_FASTCHG_MODE_V08_15 70

#define FAN_PWM_PULSE_IN_SILENT_MODE_THR                                       \
	(FAN_PWM_PULSE_IN_FASTCHG_MODE_V08_15 - 1)
...
struct oplus_chg_wls_dynamic_config {
	...
	int32_t iclmax_ma[OPLUS_WLS_CHG_BATT_CL_MAX][OPLUS_WLS_CHG_MODE_MAX]
			 [BATT_TEMP_INVALID];
	struct oplus_chg_wls_range_data fcc_step[WLS_MAX_STEP_CHG_ENTRIES];
	struct oplus_chg_wls_fcc_steps fcc_steps[WLS_FAST_SOC_MAX];
	struct oplus_chg_wls_range_data non_ffc_step[OPLUS_WLS_CHG_MODE_MAX]
						    [WLS_MAX_STEP_CHG_ENTRIES];
	struct oplus_chg_wls_range_data cv_step[OPLUS_WLS_CHG_MODE_MAX]
					       [WLS_MAX_STEP_CHG_ENTRIES];
	int32_t cool_down_step[OPLUS_WLS_CHG_MODE_MAX][WLS_COOL_DOWN_LEVEL_MAX];
	struct oplus_chg_wls_skewing_data
		skewing_step[OPLUS_WLS_SKEWING_MAX][WLS_MAX_STEP_CHG_ENTRIES];
	struct oplus_chg_wls_skin_range_data
		epp_plus_skin_step[WLS_MAX_STEP_CHG_ENTRIES];
	struct oplus_chg_wls_skin_range_data
		epp_skin_step[WLS_MAX_STEP_CHG_ENTRIES];
	struct oplus_chg_wls_skin_range_data
		bpp_skin_step[WLS_MAX_STEP_CHG_ENTRIES];
	int32_t fastchg_curr_max_ma;
	struct oplus_chg_strategy_data
		wls_fast_chg_led_off_strategy_data[CHG_STRATEGY_DATA_TABLE_MAX];
	struct oplus_chg_strategy_data
		wls_fast_chg_led_on_strategy_data[CHG_STRATEGY_DATA_TABLE_MAX];
	struct oplus_chg_wls_skin_range_data
		epp_plus_led_on_skin_step[WLS_MAX_STEP_CHG_ENTRIES];
	struct oplus_chg_wls_skin_range_data
		epp_led_on_skin_step[WLS_MAX_STEP_CHG_ENTRIES];
...
struct oplus_chg_wls {
	...
	struct oplus_chg_wls_cool_down_step
		cool_down_step[OPLUS_WLS_CHG_MODE_MAX];
