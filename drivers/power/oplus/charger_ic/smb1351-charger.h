...
#define SMB1351_MASK(LEFT_BIT_POS, RIGHT_BIT_POS)                              \
	_SMB1351_MASK((LEFT_BIT_POS) - (RIGHT_BIT_POS) + 1, (RIGHT_BIT_POS))
...
static int usb_chg_current[] = {
	500,  685,  1000, 1100, 1200, 1300, 1500,
	1600, 1700, 1800, 2000, 2200, 2500, 3000,
};

static int fast_chg_current[] = {
	1000, 1200, 1400, 1600, 1800, 2000, 2200, 2400,
	2600, 2800, 3000, 3400, 3600, 3800, 4000, 4640,
};
