...
#define REG00_MP2650_1ST_CURRENT_LIMIT_MASK                                    \
...
#define REG00_MP2650_1ST_CURRENT_LIMIT_1350MA                                  \
	(BIT(4) | BIT(3) | BIT(1) | BIT(0))
#define REG00_MP2650_1ST_CURRENT_LIMIT_1400MA (BIT(4) | BIT(3) | BIT(2))
#define REG00_MP2650_1ST_CURRENT_LIMIT_1500MA                                  \
...
#define REG00_MP2650_1ST_CURRENT_LIMIT_2750MA                                  \
	(BIT(5) | BIT(4) | BIT(2) | BIT(1) | BIT(0))
#define REG00_MP2650_1ST_CURRENT_LIMIT_3000MA                                  \
...
#define REG01_MP2650_VINDPM_THRESHOLD_MASK                                     \
...
#define REG02_MP2650_CHARGE_CURRENT_SETTING_MASK                               \
	(BIT(7) | BIT(6) | BIT(5) | BIT(4) | BIT(3) | BIT(2) | BIT(1) | BIT(0))
...
#define REG03_MP2650_TERMINATION_CURRENT_LIMIT_MASK                            \
...
#define REG03_MP2650_PRECHARGE_CURRENT_LIMIT_MASK                              \
...
#define REG04_MP2650_CHARGE_FULL_VOL_MASK                                      \
...
#define REG05_MP2650_IR_COMPENSATION_RESISTOR_CLAMP_MASK                       \
	(BIT(4) | BIT(3) | BIT(2))
...
#define REG05_MP2650_IR_COMPENSATION_RESISTOR_SETTING_MASK                     \
	(BIT(7) | BIT(6) | BIT(5))
...
#define REG06_MP2650_2ND_OTG_VOL_SETTING_MASK                                  \
	(BIT(3) | BIT(2) | BIT(1) | BIT(0))
...
#define REG06_MP2650_2ND_OTG_VOL_SETTING_400MV                                 \
	(BIT(3) | BIT(2) | BIT(1) | BIT(0))
...
#define REG0E_MP2650_DURATION_PROCHOT_ASSERTED_MASK                            \
...
#define REG0F_MP2650_2ND_CURRENT_LIMIT_MASK                                    \
	(BIT(6) | BIT(5) | BIT(4) | BIT(3) | BIT(2) | BIT(1) | BIT(0))
...
#define REG10_MP2650_2ND_CURRENT_LIMIT_TIME_MASK                               \
	(BIT(7) | BIT(6) | BIT(5) | BIT(4) | BIT(3) | BIT(2) | BIT(1) | BIT(0))
...
#define REG12_MP2650_INPUT_OVA_THRESHOLD_MASK                                  \
