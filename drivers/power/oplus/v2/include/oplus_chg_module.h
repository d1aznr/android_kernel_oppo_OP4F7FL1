...
#define oplus_chg_module_register(__name)                                      \
	__attribute__((section(".oplus_chg_module.normal.data"),               \
		       used)) struct oplus_chg_module __name##_module = {      \
		.name = #__name,                                               \
...
#define oplus_chg_module_core_register(__name)                                 \
	__attribute__((section(".oplus_chg_module.core.data"),                 \
		       used)) struct oplus_chg_module __name##_module = {      \
		.name = #__name,                                               \
		.magic = OPLUS_CHG_MODEL_MAGIC,                                \
		.chg_module_init = __name##_init,                              \
...
#define oplus_chg_module_early_register(__name)                                \
	__attribute__((section(".oplus_chg_module.early.data"),                \
		       used)) struct oplus_chg_module __name##_module = {      \
		.name = #__name,                                               \
		.magic = OPLUS_CHG_MODEL_MAGIC,                                \
		.chg_module_init = __name##_init,                              \
...
#define oplus_chg_module_late_register(__name)                                 \
	__attribute__((section(".oplus_chg_module.late.data"),                 \
		       used)) struct oplus_chg_module __name##_module = {      \
		.name = #__name,                                               \
		.magic = OPLUS_CHG_MODEL_MAGIC,                                \
		.chg_module_init = __name##_init,                              \
