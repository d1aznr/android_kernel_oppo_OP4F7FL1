...
struct oplus_chg_ic_debug_data {
	...
	ssize_t (*get_func_data)(struct oplus_chg_ic_dev *,
				 enum oplus_chg_ic_func, void *);
	int (*set_func_data)(struct oplus_chg_ic_dev *, enum oplus_chg_ic_func,
			     const void *, size_t);
};
...
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_SMT_TEST)
(struct oplus_chg_ic_dev *, char buf[], int len);
/* buck/boost */
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_INPUT_PRESENT)
(struct oplus_chg_ic_dev *, bool *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_INPUT_SUSPEND)
(struct oplus_chg_ic_dev *, bool);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_INPUT_IS_SUSPEND)
(struct oplus_chg_ic_dev *, bool *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_OUTPUT_SUSPEND)
(struct oplus_chg_ic_dev *, bool);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_OUTPUT_IS_SUSPEND)
(struct oplus_chg_ic_dev *, bool *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_SET_ICL)
(struct oplus_chg_ic_dev *, bool, bool, int);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_GET_ICL)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_SET_FCC)
(struct oplus_chg_ic_dev *, int);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_SET_FV)
(struct oplus_chg_ic_dev *, int);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_SET_ITERM)
(struct oplus_chg_ic_dev *, int);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_SET_RECHG_VOL)
(struct oplus_chg_ic_dev *, int);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_GET_INPUT_CURR)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_GET_INPUT_VOL)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_AICL_ENABLE)
(struct oplus_chg_ic_dev *, bool);
...
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_GET_CC_ORIENTATION)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_GET_HW_DETECT)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_GET_CHARGER_TYPE)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_RERUN_BC12)(struct oplus_chg_ic_dev *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_QC_DETECT_ENABLE)
(struct oplus_chg_ic_dev *, bool);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_SHIPMODE_ENABLE)
(struct oplus_chg_ic_dev *, bool);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_SET_QC_CONFIG)
(struct oplus_chg_ic_dev *, enum oplus_chg_qc_version, int);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_SET_PD_CONFIG)
(struct oplus_chg_ic_dev *, u32);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_GET_VBUS_COLLAPSE_STATUS)
(struct oplus_chg_ic_dev *, bool *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_CC_DETECT_HAPPENED)
(struct oplus_chg_ic_dev *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_CURR_DROP)(struct oplus_chg_ic_dev *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_WDT_ENABLE)
(struct oplus_chg_ic_dev *, bool);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_KICK_WDT)(struct oplus_chg_ic_dev *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_BC12_COMPLETED)
(struct oplus_chg_ic_dev *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_SET_AICL_POINT)
(struct oplus_chg_ic_dev *, int);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_SET_VINDPM)
(struct oplus_chg_ic_dev *, int);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BUCK_HARDWARE_INIT)
(struct oplus_chg_ic_dev *);

/* gauge */
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_UPDATE)(struct oplus_chg_ic_dev *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_VOL)
(struct oplus_chg_ic_dev *, int, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_MAX)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_MIN)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_CURR)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_TEMP)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_SOC)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_FCC)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_CC)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_RM)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_SOH)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_AUTH)
(struct oplus_chg_ic_dev *, bool *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_HMAC)
(struct oplus_chg_ic_dev *, bool *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_SET_BATT_FULL)
(struct oplus_chg_ic_dev *, bool);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_FC)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_QM)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_PD)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_RCU)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_RCF)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_FCU)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_FCF)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_SOU)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_DO0)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_DOE)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_TRM)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_PC)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_QS)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_UPDATE_DOD0)
(struct oplus_chg_ic_dev *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_UPDATE_SOC_SMOOTH)
(struct oplus_chg_ic_dev *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_CB_STATUS)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_PASSEDCHG)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_SET_LOCK)
(struct oplus_chg_ic_dev *, bool);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_IS_LOCKED)
(struct oplus_chg_ic_dev *, bool *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_NUM)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_DEVICE_TYPE)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_DEVICE_TYPE_FOR_VOOC)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_EXIST)
(struct oplus_chg_ic_dev *, bool *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BATT_CAP)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_IS_SUSPEND)
(struct oplus_chg_ic_dev *, bool *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_BCC_PARMS)
(struct oplus_chg_ic_dev *, char *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_FASTCHG_UPDATE_BCC_PARMS)
(struct oplus_chg_ic_dev *, char *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_PREV_BCC_PARMS)
(struct oplus_chg_ic_dev *, char *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_SET_BCC_PARMS)
(struct oplus_chg_ic_dev *, const char *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_SET_PROTECT_CHECK)
(struct oplus_chg_ic_dev *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_GET_AFI_UPDATE_DONE)
(struct oplus_chg_ic_dev *, bool *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_CHECK_RESET)
(struct oplus_chg_ic_dev *, bool *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GAUGE_SET_RESET)
(struct oplus_chg_ic_dev *, bool *);

/* misc */
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GET_CHARGER_CYCLE)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_OTG_BOOST_ENABLE)
(struct oplus_chg_ic_dev *, bool);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_SET_OTG_BOOST_VOL)
(struct oplus_chg_ic_dev *, int);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_SET_OTG_BOOST_CURR_LIMIT)
(struct oplus_chg_ic_dev *, int);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_WLS_BOOST_ENABLE)
(struct oplus_chg_ic_dev *, bool);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_SET_WLS_BOOST_VOL)
(struct oplus_chg_ic_dev *, int);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_SET_WLS_BOOST_CURR_LIMIT)
(struct oplus_chg_ic_dev *, int);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GET_SHUTDOWN_SOC)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_BACKUP_SOC)(struct oplus_chg_ic_dev *, int);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GET_USB_TEMP)
(struct oplus_chg_ic_dev *, int *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GET_USB_TEMP_VOLT)
(struct oplus_chg_ic_dev *, int *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_USB_TEMP_CHECK_IS_SUPPORT)
(struct oplus_chg_ic_dev *, bool *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GET_TYPEC_MODE)
(struct oplus_chg_ic_dev *, enum oplus_chg_typec_port_role_type *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_SET_TYPEC_MODE)
(struct oplus_chg_ic_dev *, enum oplus_chg_typec_port_role_type);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_SET_USB_DISCHG_ENABLE)
(struct oplus_chg_ic_dev *, bool);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GET_USB_DISCHG_STATUS)
(struct oplus_chg_ic_dev *, bool *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_SET_OTG_SWITCH_STATUS)
(struct oplus_chg_ic_dev *, bool);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GET_OTG_SWITCH_STATUS)
(struct oplus_chg_ic_dev *, bool *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GET_OTG_ONLINE_STATUS)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GET_OTG_ENABLE)
(struct oplus_chg_ic_dev *, bool *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GET_CHARGER_VOL_MAX)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GET_CHARGER_VOL_MIN)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GET_CHARGER_CURR_MAX)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_DISABLE_VBUS)
(struct oplus_chg_ic_dev *, bool, bool);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_IS_OPLUS_SVID)
(struct oplus_chg_ic_dev *, bool *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_GET_DATA_ROLE)
(struct oplus_chg_ic_dev *, int *);

/* voocphy */
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOCPHY_ENABLE)
(struct oplus_chg_ic_dev *, bool);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOCPHY_RESET_AGAIN)
(struct oplus_chg_ic_dev *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOCPHY_SET_CURR_LEVEL)
(struct oplus_chg_ic_dev *, int);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOCPHY_SET_MATCH_TEMP)
(struct oplus_chg_ic_dev *, int);

/* vooc */
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOC_FW_UPGRADE)(struct oplus_chg_ic_dev *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOC_USER_FW_UPGRADE)
(struct oplus_chg_ic_dev *, const u8 *, u32);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOC_FW_CHECK_THEN_RECOVER)
(struct oplus_chg_ic_dev *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOC_FW_CHECK_THEN_RECOVER_FIX)
(struct oplus_chg_ic_dev *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOC_GET_FW_VERSION)
(struct oplus_chg_ic_dev *, u32 *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOC_EINT_REGISTER)
(struct oplus_chg_ic_dev *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOC_EINT_UNREGISTER)
(struct oplus_chg_ic_dev *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOC_SET_DATA_ACTIVE)
(struct oplus_chg_ic_dev *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOC_SET_DATA_SLEEP)
(struct oplus_chg_ic_dev *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOC_SET_CLOCK_ACTIVE)
(struct oplus_chg_ic_dev *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOC_SET_CLOCK_SLEEP)
(struct oplus_chg_ic_dev *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOC_SET_SWITCH_MODE)
(struct oplus_chg_ic_dev *, int);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOC_GET_SWITCH_MODE)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOC_GET_DATA_GPIO_VAL)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOC_GET_RESET_GPIO_VAL)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOC_GET_CLOCK_GPIO_VAL)
(struct oplus_chg_ic_dev *, int *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOC_READ_DATA_BIT)
(struct oplus_chg_ic_dev *, bool *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOC_REPLY_DATA)
(struct oplus_chg_ic_dev *, int, int);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOC_RESET_ACTIVE)
(struct oplus_chg_ic_dev *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOC_RESET_ACTIVE_FORCE)
(struct oplus_chg_ic_dev *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOC_RESET_SLEEP)
(struct oplus_chg_ic_dev *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOC_BOOT_BY_GPIO)
(struct oplus_chg_ic_dev *, bool *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOC_UPGRADING)
(struct oplus_chg_ic_dev *, bool *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOC_CHECK_FW_STATUS)
(struct oplus_chg_ic_dev *, bool *);
OPLUS_CHG_IC_FUNC_DEF(OPLUS_IC_FUNC_VOOC_GET_IC_DEV)
(struct oplus_chg_ic_dev *, struct oplus_chg_ic_dev **);
...
struct oplus_chg_ic_dev *
devm_oplus_chg_ic_register(struct device *dev, struct oplus_chg_ic_cfg *cfg);
