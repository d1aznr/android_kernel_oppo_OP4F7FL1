...
static struct oplus_adapter_struct adapter_id_table[] = {
	...
	{ 0x11, 0x12, ADAPTER_POWER_30W, ADAPTER_POWER_50W, ADAPTER_TYPE_AC,
	  CHARGER_TYPE_SVOOC },
	{ 0x13, 0x13, ADAPTER_POWER_20W, ADAPTER_POWER_UNKNOWN, ADAPTER_TYPE_AC,
	  CHARGER_TYPE_VOOC },
	{ 0x14, 0x14, ADAPTER_POWER_30W, ADAPTER_POWER_65W, ADAPTER_TYPE_AC,
	  CHARGER_TYPE_SVOOC },
	{ 0x19, 0x19, ADAPTER_POWER_30W, ADAPTER_POWER_UNKNOWN, ADAPTER_TYPE_AC,
	  CHARGER_TYPE_VOOC },
	{ 0x21, 0x21, ADAPTER_POWER_30W, ADAPTER_POWER_50W, ADAPTER_TYPE_CAR,
	  CHARGER_TYPE_SVOOC },
	{ 0x29, 0x29, ADAPTER_POWER_30W, ADAPTER_POWER_UNKNOWN,
	  ADAPTER_TYPE_CAR, CHARGER_TYPE_VOOC },
	{ 0x31, 0x31, ADAPTER_POWER_30W, ADAPTER_POWER_50W, ADAPTER_TYPE_PB,
	  CHARGER_TYPE_SVOOC },
	{ 0x32, 0x32, ADAPTER_POWER_30W, ADAPTER_POWER_65W, ADAPTER_TYPE_PB,
	  CHARGER_TYPE_SVOOC },
	{ 0x33, 0x33, ADAPTER_POWER_30W, ADAPTER_POWER_50W, ADAPTER_TYPE_PB,
	  CHARGER_TYPE_SVOOC },
	{ 0x34, 0x34, ADAPTER_POWER_20W, ADAPTER_POWER_20W, ADAPTER_TYPE_PB,
	  CHARGER_TYPE_NORMAL },
	{ 0x35, 0x36, ADAPTER_POWER_30W, ADAPTER_POWER_65W, ADAPTER_TYPE_PB,
	  CHARGER_TYPE_SVOOC },
	{ 0x41, 0x41, ADAPTER_POWER_30W, ADAPTER_POWER_UNKNOWN, ADAPTER_TYPE_AC,
	  CHARGER_TYPE_VOOC },
	{ 0x42, 0x46, ADAPTER_POWER_UNKNOWN, ADAPTER_POWER_UNKNOWN,
	  ADAPTER_TYPE_UNKNOWN, CHARGER_TYPE_VOOC },
	{ 0x49, 0x4a, ADAPTER_POWER_15W, ADAPTER_POWER_33W, ADAPTER_TYPE_AC,
	  CHARGER_TYPE_SVOOC },
	{ 0x4b, 0x4e, ADAPTER_POWER_30W, ADAPTER_POWER_80W, ADAPTER_TYPE_AC,
	  CHARGER_TYPE_SVOOC },
	{ 0x61, 0x61, ADAPTER_POWER_15W, ADAPTER_POWER_33W, ADAPTER_TYPE_AC,
	  CHARGER_TYPE_SVOOC },
	{ 0x62, 0x62, ADAPTER_POWER_30W, ADAPTER_POWER_50W, ADAPTER_TYPE_AC,
	  CHARGER_TYPE_SVOOC },
	{ 0x63, 0x64, ADAPTER_POWER_30W, ADAPTER_POWER_65W, ADAPTER_TYPE_AC,
	  CHARGER_TYPE_SVOOC },
	{ 0x65, 0x65, ADAPTER_POWER_30W, ADAPTER_POWER_80W, ADAPTER_TYPE_AC,
	  CHARGER_TYPE_SVOOC },
	{ 0x66, 0x66, ADAPTER_POWER_30W, ADAPTER_POWER_65W, ADAPTER_TYPE_AC,
	  CHARGER_TYPE_SVOOC },
	{ 0x69, 0x6b, ADAPTER_POWER_30W, ADAPTER_POWER_100W, ADAPTER_TYPE_AC,
	  CHARGER_TYPE_SVOOC },
	{ 0x6c, 0x6e, ADAPTER_POWER_30W, ADAPTER_POWER_65W, ADAPTER_TYPE_AC,
	  CHARGER_TYPE_SVOOC },
};
...
static void oplus_select_abnormal_max_cur(struct oplus_chg_vooc *chip)
{
	...
	chg_info("abnormal info [%d %d %d %d %d] \n", chip->pd_svooc,
		 chip->support_abnormal_adapter, chip->abnormal_adapter_dis_cnt,
