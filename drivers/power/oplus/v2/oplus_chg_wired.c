...
static struct oplus_wired_spec_config default_config = {
	...
	.fcc_ma = { {
			    { 0, 0, 500, 500, 500, 500, 500,
			      0 }, /* OPLUS_WIRED_CHG_MODE_UNKNOWN */
			    { 0, 0, 500, 500, 500, 500, 500,
			      0 }, /* OPLUS_WIRED_CHG_MODE_SDP */
			    { 0, 0, 500, 500, 500, 500, 500,
			      0 }, /* OPLUS_WIRED_CHG_MODE_CDP */
			    { 0, 0, 500, 500, 500, 500, 500,
			      0 }, /* OPLUS_WIRED_CHG_MODE_DCP */
			    { 0, 0, 500, 500, 500, 500, 500,
			      0 }, /* OPLUS_WIRED_CHG_MODE_VOOC */
			    { 0, 0, 500, 500, 500, 500, 500,
			      0 }, /* OPLUS_WIRED_CHG_MODE_QC */
			    { 0, 0, 500, 500, 500, 500, 500,
			      0 }, /* OPLUS_WIRED_CHG_MODE_PD */
		    },
		    {
			    { 0, 0, 500, 500, 500, 500, 500,
			      0 }, /* OPLUS_WIRED_CHG_MODE_UNKNOWN */
...
#define OPLUS_PD_9V_PDO 0x32d12c
	...
	case OPLUS_ACTION_BOOST:
		...
		if (spec->vbatt_pdqc_to_9v_thr > 0 &&
			...
			chg_info(
				"battery voltage too high, pd cannot be boosted\n");
			chip->pd_action = OPLUS_ACTION_NULL;
			goto set_curr;
		}
		chip->vbus_set_mv = 9000;
