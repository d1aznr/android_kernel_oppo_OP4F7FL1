...
#define VOOC2_CIRCUIT_R_H_DEF                                                  \
	((R_DET_BIT9 << TX1_DET_BIT1_SHIFT) |                                  \
	 (R_DET_BIT8 << TX1_DET_BIT0_SHIFT))
#define VOOC2_CIRCUIT_R_L_DEF                                                  \
	((R_DET_BIT5 << TX0_DET_BIT2_SHIFT) |                                  \
	 (R_DET_BIT6 << TX0_DET_BIT3_SHIFT) |                                  \
	 (R_DET_BIT7 << TX0_DET_BIT4_SHIFT))
#define NO_VOOC2_CIRCUIT_R_H_DEF                                               \
	((R_DET_BIT9 << TX1_DET_BIT1_SHIFT) |                                  \
	 (R_DET_BIT8 << TX1_DET_BIT0_SHIFT))
#define NO_VOOC2_CIRCUIT_R_L_DEF                                               \
	((R_DET_BIT4 << TX0_DET_BIT1_SHIFT) |                                  \
	 (R_DET_BIT5 << TX0_DET_BIT2_SHIFT) |                                  \
	 (R_DET_BIT6 << TX0_DET_BIT3_SHIFT) |                                  \
	 (R_DET_BIT7 << TX0_DET_BIT4_SHIFT))
...
#define BURR_VOOC2_CIRCUIT_R                                                   \
	((R_DET_BIT4 << 4) | (R_DET_BIT5 << 3) | (R_DET_BIT6 << 2) |           \
...
#define NO_VOOC3_CIRCUIT_R_H_DEF                                               \
	((R_DET_BIT_VOOC30_9 << TX1_DET_BIT1_SHIFT) |                          \
	 (R_DET_BIT_VOOC30_8 << TX1_DET_BIT0_SHIFT))
#define NO_VOOC3_CIRCUIT_R_L_DEF                                               \
	((R_DET_BIT_VOOC30_4 << TX0_DET_BIT1_SHIFT) |                          \
	 (R_DET_BIT_VOOC30_5 << TX0_DET_BIT2_SHIFT) |                          \
	 (R_DET_BIT_VOOC30_6 << TX0_DET_BIT3_SHIFT) |                          \
	 (R_DET_BIT_VOOC30_7 << TX0_DET_BIT4_SHIFT))
...
#define VOOC2_CIRCUIT_PARALLEL_R_H_DEF                                         \
	((R_DET_PARALLEL_BIT9 << TX1_DET_BIT1_SHIFT) |                         \
	 (R_DET_PARALLEL_BIT8 << TX1_DET_BIT0_SHIFT))
#define VOOC2_CIRCUIT_PARALLEL_R_L_DEF                                         \
	((R_DET_PARALLEL_BIT5 << TX0_DET_BIT2_SHIFT) |                         \
	 (R_DET_PARALLEL_BIT6 << TX0_DET_BIT3_SHIFT) |                         \
	 (R_DET_PARALLEL_BIT7 << TX0_DET_BIT4_SHIFT))
#define NO_VOOC2_CIRCUIT_PARALLEL_R_H_DEF                                      \
	((R_DET_PARALLEL_BIT9 << TX1_DET_BIT1_SHIFT) |                         \
	 (R_DET_PARALLEL_BIT8 << TX1_DET_BIT0_SHIFT))
#define NO_VOOC2_CIRCUIT_PARALLEL_R_L_DEF                                      \
	((R_DET_PARALLEL_BIT4 << TX0_DET_BIT1_SHIFT) |                         \
	 (R_DET_PARALLEL_BIT5 << TX0_DET_BIT2_SHIFT) |                         \
	 (R_DET_PARALLEL_BIT6 << TX0_DET_BIT3_SHIFT) |                         \
	 (R_DET_PARALLEL_BIT7 << TX0_DET_BIT4_SHIFT))
#define BURR_VOOC2_CIRCUIT_PARALLEL_R                                          \
	((R_DET_PARALLEL_BIT4 << 4) | (R_DET_PARALLEL_BIT5 << 3) |             \
	 (R_DET_PARALLEL_BIT6 << 2) | (R_DET_PARALLEL_BIT7 << 1) |             \
	 (R_DET_PARALLEL_BIT8))
...
#define NO_VOOC3_CIRCUIT_PARALLEL_R_H_DEF                                      \
	((R_DET_PARALLEL_BIT_VOOC30_9 << TX1_DET_BIT1_SHIFT) |                 \
	 (R_DET_PARALLEL_BIT_VOOC30_8 << TX1_DET_BIT0_SHIFT))
#define NO_VOOC3_CIRCUIT_PARALLEL_R_L_DEF                                      \
	((R_DET_PARALLEL_BIT_VOOC30_4 << TX0_DET_BIT1_SHIFT) |                 \
	 (R_DET_PARALLEL_BIT_VOOC30_5 << TX0_DET_BIT2_SHIFT) |                 \
	 (R_DET_PARALLEL_BIT_VOOC30_6 << TX0_DET_BIT3_SHIFT) |                 \
	 (R_DET_PARALLEL_BIT_VOOC30_7 << TX0_DET_BIT4_SHIFT))
/* 2.batt sys array*/
...
#define VOOCPHY_DATA16_SPLIT(data_src, data_l, data_h)                         \
	do {                                                                   \
		...
		data_h = ((data_src) >> VOOCPHY_DATA_H_SHIFT) &                \
			 VOOCPHY_DATA_MASK;                                    \
	} while (0);
...
struct oplus_voocphy_operations {
	...
	int (*set_adc_forcedly_enable)(struct oplus_voocphy_manager *chip,
				       int mode);
	...
	void (*set_pd_svooc_config)(struct oplus_voocphy_manager *chip,
				    bool enable);
	...
	int (*set_chg_auto_mode)(struct oplus_voocphy_manager *chip,
				 bool enable);
...
bool oplus_voocphy_get_pdsvooc_adapter_config(
