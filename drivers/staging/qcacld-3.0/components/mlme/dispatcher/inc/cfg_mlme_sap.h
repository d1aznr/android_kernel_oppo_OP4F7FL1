 ...
 */
//else
#define CFG_SAP_MAX_NO_PEERS                                                   \
	CFG_INI_UINT("gSoftApMaxPeers", 1, 32, 10, CFG_VALUE_OR_DEFAULT,       \
		     "max no of peers")
 ...
 * </ini>
 */
#define CFG_SAP_MAX_OFFLOAD_PEERS                                              \
	CFG_INI_UINT("gMaxOffloadPeers", 2, 5, 2, CFG_VALUE_OR_DEFAULT,        \
		     "max offload peers")
