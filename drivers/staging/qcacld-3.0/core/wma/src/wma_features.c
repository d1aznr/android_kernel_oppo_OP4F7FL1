...
static void wma_log_pkt_ipv4(uint8_t *data, uint32_t length)
{
	...
	WMA_LOGD("src addr %d:%d:%d:%d", ip_addr[0], ip_addr[1],
		 ip_addr[2], ip_addr[3]);
#else
	WMA_LOGE("src addr %d:%d:%d:%d", ip_addr[0], ip_addr[1], ip_addr[2],
		 ip_addr[3]);
	...
	WMA_LOGD("dst addr %d:%d:%d:%d", ip_addr[0], ip_addr[1],
		 ip_addr[2], ip_addr[3]);
#else
	WMA_LOGE("dst addr %d:%d:%d:%d", ip_addr[0], ip_addr[1], ip_addr[2],
		 ip_addr[3]);
#endif /* OPLUS_BUG_DEBUG */
...
static void wma_log_pkt_ipv6(uint8_t *data, uint32_t length)
{
	...
	WMA_LOGD("src addr "IPV6_ADDR_STR, ip_addr[0],
		 ...
		 ip_addr[15]);
#else
	WMA_LOGE("src addr " IPV6_ADDR_STR, ip_addr[0], ip_addr[1], ip_addr[2],
		 ip_addr[3], ip_addr[4], ip_addr[5], ip_addr[6], ip_addr[7],
		 ip_addr[8], ip_addr[9], ip_addr[10], ip_addr[11], ip_addr[12],
		 ip_addr[13], ip_addr[14], ip_addr[15]);
#endif /* OPLUS_BUG_DEBUG */
	...
	WMA_LOGD("dst addr "IPV6_ADDR_STR, ip_addr[0],
		 ...
		 ip_addr[15]);
#else
	WMA_LOGE("dst addr " IPV6_ADDR_STR, ip_addr[0], ip_addr[1], ip_addr[2],
		 ip_addr[3], ip_addr[4], ip_addr[5], ip_addr[6], ip_addr[7],
		 ip_addr[8], ip_addr[9], ip_addr[10], ip_addr[11], ip_addr[12],
		 ip_addr[13], ip_addr[14], ip_addr[15]);
#endif /* OPLUS_BUG_DEBUG */
