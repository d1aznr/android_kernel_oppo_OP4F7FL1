...
{
	routerboost_sysctl_table_header = register_net_sysctl(
		&init_net, "net/oplus_routerboost", routerboost_sysctl_table);
...
static int handle_nlmsg_set_game_uid(struct nlattr *nla)
{
	...
	set_game_monitor_uid(
		uid); /*defined in oplus_routerboost_game_monitor.c*/
	return 0;
}
...
static int handle_nlmsg_set_wlan_index(struct nlattr *nla)
{
	...
	set_game_monitor_wlan_index(
		monitor_wlan_index); /*defined in oplus_routerboost_game_monitor.c*/
	return 0;
}
...
static int handle_nlmsg_set_game_playing_state(struct nlattr *nla)
{
	...
	set_game_playing_state(
		is_playing); /*defined in oplus_routerboost_game_monitor.c*/
	return 0;
}
